...
## <a name="Contents" id="core-unicode-locale-data-markup-language-ldml-contents-of-part-1-core" href="#Contents">Contents of Part 1, Core</a>
...
## <a name="Introduction" id="core-unicode-locale-data-markup-language-ldml-introduction" href="#Introduction">Introduction</a>

* <a id="core-introduction-item-1"></a> **Not long ago**: Not long ago, computer systems were like separate worlds, isolated from one another.

* <a id="core-introduction-item-2"></a> **The internet and**: The internet and related events have changed all that.

* <a id="core-introduction-item-3"></a> **A single system**: A single system can be built of many different components, hardware and software, all needing to work together.

* <a id="core-introduction-item-4"></a> **Many different technologies**: Many different technologies have been important in bridging the gaps; in the internationalization arena, Unicode has provided a lingua franca for communicating textual data.

* <a id="core-introduction-item-5"></a> **However, there remain**: However, there remain differences in the locale data used by different systems.


* <a id="core-introduction-item-6"></a> **The best practice**: The best practice for internationalization is to store and communicate language-neutral data, and format that data for the client.

* <a id="core-introduction-item-7"></a> **This formatting can**: This formatting can take place on any of a number of the components in a system; a server might format data based on the user's locale, or it could be that a client machine does the formatting.

* <a id="core-introduction-item-8"></a> **The same goes**: The same goes for parsing data, and locale-sensitive analysis of data.


* <a id="core-introduction-item-9"></a> **But there remain**: But there remain significant differences across systems and applications in the locale-sensitive data used for such formatting, parsing, and analysis.

* <a id="core-introduction-item-10"></a> **Many of those**: Many of those differences are simply gratuitous; all within acceptable limits for human beings, but yielding different results.

* <a id="core-introduction-item-11"></a> **In many other**: In many other cases there are outright errors.

* <a id="core-introduction-item-12"></a> **Whatever the cause**: Whatever the cause, the differences can cause discrepancies to creep into a heterogeneous system.

* <a id="core-introduction-item-13"></a> **This is especially**: This is especially serious in the case of collation (sort-order), where different collation caused not only ordering differences, but also different results of queries!

* <a id="core-introduction-item-14"></a> **That is, with**: That is, with a query of customers with names between "Abbot, Cosmo" and "Arnold, James", if different systems have different sort orders, different lists will be returned. (For comparisons across systems formatted as HTML tables, see [[Comparisons](#Comparisons)].)



### Notes <a id="core-unicode-locale-data-markup-language-ldml-introduction-notes"></a>

* <a id="core-introduction-note-1"></a> **Note 1**: There are many different equally valid ways in which data can be judged to be "correct" for a particular locale. The goal for the common locale data is to make it as consistent as possible with existing locale data, and acceptable to users in that locale.

* <a id="core-introduction-notes-item-1"></a> **This document specifies**: This document specifies an XML format for the communication of locale data: the Unicode Locale Data Markup Language (LDML).

* <a id="core-introduction-notes-item-2"></a> **This provides a**: This provides a common format for systems to interchange locale data so that they can get the same results in the services provided by internationalization libraries.

* <a id="core-introduction-notes-item-3"></a> **It also provides**: It also provides a standard format that can allow users to customize the behavior of a system.

* <a id="core-introduction-notes-item-4"></a> **With it, for**: With it, for example, collation (sorting) rules can be exchanged, allowing two implementations to exchange a specification of tailored collation rules.

* <a id="core-introduction-notes-item-5"></a> **Using the same**: Using the same specification, the two implementations will achieve the same results in comparing strings.

* <a id="core-introduction-notes-item-6"></a> **Unicode LDML can**: Unicode LDML can also be used to let a user encapsulate specialized sorting behavior for a specific domain, or create a customized locale for a minority language.

* <a id="core-introduction-notes-item-7"></a> **Unicode LDML is**: Unicode LDML is also used in the Unicode Common Locale Data Repository (CLDR).

* <a id="core-introduction-notes-item-8"></a> **CLDR uses an**: CLDR uses an open process for reconciling differences between the locale data used on different systems and validating the data, to produce with a useful, common, consistent base of locale data.


For more information, see the Common Locale Data Repository project page [[LocaleProject](#localeProject)].

* <a id="core-introduction-notes-item-9"></a> **As LDML is**: As LDML is an interchange format, it was designed for ease of maintenance and simplicity of transformation into other formats, above efficiency of run-time lookup and use.

* <a id="core-introduction-notes-item-10"></a> **Implementations should consider**: Implementations should consider converting LDML data into a more compact format prior to use.


### <a name="Conformance" id="core-unicode-locale-data-markup-language-ldml-introduction-conformance" href="#Conformance">Conformance</a>
...
#### Notes <a id="core-unicode-locale-data-markup-language-ldml-introduction-conformance-notes"></a>

* <a id="core-introduction-conformance-note-1"></a> **Note 1**: _**UAX35-C2.**_ is replaced by the following generalization.
...
## <a name="Locale" id="core-unicode-locale-data-markup-language-ldml-what-is-a-locale" href="#Locale">What is a Locale?</a>

* <a id="core-what-is-a-locale-item-1"></a> **Before diving into**: Before diving into the XML structure, it is helpful to describe the model behind the structure.

* <a id="core-what-is-a-locale-item-2"></a> **People do not**: People do not have to subscribe to this model to use data in LDML, but they do need to understand it so that the data can be correctly translated into whatever model their implementation uses.


* <a id="core-what-is-a-locale-item-3"></a> **The first issue**: The first issue is basic: _what is a locale?_ In this model, a locale is an identifier (id) that refers to a set of user preferences that tend to be shared across significant swaths of the world.

* <a id="core-what-is-a-locale-item-4"></a> **Traditionally, the data**: Traditionally, the data associated with this id provides support for formatting and parsing of dates, times, numbers, and currencies; for measurement units, for sort-order (collation), plus translated names for time zones, languages, countries (regions), and scripts.

* <a id="core-what-is-a-locale-item-5"></a> **The data can**: The data can also include support for text boundaries (character, word, line, and sentence), text transformations (including transliterations), and other services.


* <a id="core-what-is-a-locale-item-6"></a> **Locale data is**: Locale data is not cast in stone: the data used on someone's machine generally may reflect the US format, for example, but preferences can typically set to override particular items, such as setting the date format for 2002.03.15, or using metric or Imperial measurement units.

* <a id="core-what-is-a-locale-item-7"></a> **In the abstract**: In the abstract, locales are simply one of many sets of preferences that, say, a website may want to remember for a particular user.

* <a id="core-what-is-a-locale-item-8"></a> **Depending on the**: Depending on the application, it may want to also remember the user's time zone, preferred currency, preferred character set, smoker/non-smoker preference, meal preference (vegetarian, kosher, and so on), music preference, religion, party affiliation, favorite charity, and so on.


* <a id="core-what-is-a-locale-item-9"></a> **Locale data in**: Locale data in a system may also change over time: country boundaries change; governments (and currencies) come and go: committees impose new standards; bugs are found and fixed in the source data; and so on.

* <a id="core-what-is-a-locale-item-10"></a> **Thus the data**: Thus the data needs to be versioned for stability over time.


* <a id="core-what-is-a-locale-item-11"></a> **In general terms**: In general terms, the locale id is a parameter that is supplied to a particular service (date formatting, sorting, spell-checking, and so on).

* <a id="core-what-is-a-locale-item-12"></a> **The format in**: The format in this document does not attempt to represent all the data that could conceivably be used by all possible services.

* <a id="core-what-is-a-locale-item-13"></a> **Instead, it collects**: Instead, it collects together data that is in common use in systems and internationalization libraries for basic services.

* <a id="core-what-is-a-locale-item-14"></a> **The main difference**: The main difference among locales is in terms of language; there may also be some differences according to different countries or regions.

* <a id="core-what-is-a-locale-item-15"></a> **However, the line**: However, the line between _locales_ and _languages_, as commonly used in the industry, are rather fuzzy.

* <a id="core-what-is-a-locale-item-16"></a> **Note also that**: Note also that the vast majority of the locale data in CLDR is in fact language data; all non-linguistic data is separated out into a separate tree.

* <a id="core-what-is-a-locale-item-17"></a> **For more information**: For more information, see _[Language and Locale IDs](#Language_and_Locale_IDs)_.


* <a id="core-what-is-a-locale-item-18"></a> **We will speak**: We will speak of data as being "in locale X".

* <a id="core-what-is-a-locale-item-19"></a> **That does not**: That does not imply that a locale _is_ a collection of data; it is simply shorthand for "the set of data associated with the locale id X".

* <a id="core-what-is-a-locale-item-20"></a> **Each individual piece**: Each individual piece of data is called a _resource_ or _field_, and a tag indicating the key of the resource is called a _resource tag._



<a name="Identifiers"></a>
## <a name="Unicode_Language_and_Locale_Identifiers" id="core-unicode-locale-data-markup-language-ldml-unicode-language-and-locale-identifiers" href="#Unicode_Language_and_Locale_Identifiers">Unicode Language and Locale Identifiers</a>

* <a id="core-unicode-language-and-locale-identifiers-item-1"></a> **Unicode LDML uses**: Unicode LDML uses stable identifiers based on [[BCP47](#BCP47)] for distinguishing among languages, locales, regions, currencies, time zones, transforms, and so on.

* <a id="core-unicode-language-and-locale-identifiers-item-2"></a> **There are many**: There are many systems for identifiers for these entities.

* <a id="core-unicode-language-and-locale-identifiers-item-3"></a> **The Unicode LDML**: The Unicode LDML identifiers may not match the identifiers used on a particular target system.

* <a id="core-unicode-language-and-locale-identifiers-item-4"></a> **If so, some**: If so, some process of identifier translation may be required when using LDML data.
...
* <a id="core-unicode-language-and-locale-identifiers-unicode-language-identifier-item-1"></a> **A _Unicode language**: A _Unicode language identifier_ has the following structure (provided in EBNF (Perl-based)).

* <a id="core-unicode-language-and-locale-identifiers-unicode-language-identifier-item-2"></a> **The following table**: The following table defines syntactically well-formed identifiers: they are not necessarily valid identifiers.

* <a id="core-unicode-language-and-locale-identifiers-unicode-language-identifier-item-3"></a> **For additional validity**: For additional validity criteria, see the links on the right.
...
* <a id="core-unicode-language-and-locale-identifiers-unicode-language-identifier-item-4"></a> **The semantics of**: The semantics of the various subtags is explained in _[Language Identifier Field Definitions](#Field_Definitions)_ ; there are also direct links from [`unicode_language_subtag`](#unicode_language_subtag) , etc.

* <a id="core-unicode-language-and-locale-identifiers-unicode-language-identifier-item-5"></a> **While theoretically the**: While theoretically the [`unicode_language_subtag`](#unicode_language_subtag) may have more than 3 letters through the IANA registration process, in practice that has not occurred.

* <a id="core-unicode-language-and-locale-identifiers-unicode-language-identifier-item-6"></a> **The [`unicode_language_subtag`](#unicode_language_subtag) "und**: The [`unicode_language_subtag`](#unicode_language_subtag) "und" may be omitted when there is a [`unicode_script_subtag`](#unicode_script_subtag) ; for that reason [`unicode_language_subtag`](#unicode_language_subtag) values with 4 letters are not permitted.

* <a id="core-unicode-language-and-locale-identifiers-unicode-language-identifier-item-7"></a> **However, such [`unicode_language_id`](#unicode_language_id**: However, such [`unicode_language_id`](#unicode_language_id) values are not intended for general interchange, because they are not valid BCP 47 tags.

* <a id="core-unicode-language-and-locale-identifiers-unicode-language-identifier-item-8"></a> **Instead, they are**: Instead, they are intended for certain protocols such as the identification of transliterators or font ScriptLangTag values.

* <a id="core-unicode-language-and-locale-identifiers-unicode-language-identifier-item-9"></a> **For more information**: For more information on language subtags with 4 letters, see [BCP 47 Language Tag to Unicode BCP 47 Locale Identifier](#Language_Tag_to_Locale_Identifier).
...
* <a id="core-unicode-language-and-locale-identifiers-unicode-locale-identifier-item-1"></a> **A _Unicode locale**: A _Unicode locale identifier_ is composed of a Unicode language identifier plus (optional) locale extensions.

* <a id="core-unicode-language-and-locale-identifiers-unicode-locale-identifier-item-2"></a> **It has the**: It has the following structure.

* <a id="core-unicode-language-and-locale-identifiers-unicode-locale-identifier-item-3"></a> **The semantics of**: The semantics of the U and T extensions are explained in _[Unicode BCP 47 U Extension](#u_Extension)_ and _[Unicode BCP 47 T Extension](#BCP47_T_Extension)_.

* <a id="core-unicode-language-and-locale-identifiers-unicode-locale-identifier-item-4"></a> **Other extensions and**: Other extensions and private use extensions are supported for pass-through.

* <a id="core-unicode-language-and-locale-identifiers-unicode-locale-identifier-item-5"></a> **The following table**: The following table defines syntactically _well-formed_ identifiers: they are not necessarily _valid_ identifiers.

* <a id="core-unicode-language-and-locale-identifiers-unicode-locale-identifier-item-6"></a> **For additional validity**: For additional validity criteria, see the links on the right.
...
* <a id="core-unicode-language-and-locale-identifiers-unicode-locale-identifier-item-7"></a> **For historical reasons**: For historical reasons, this is called a Unicode locale identifier.

* <a id="core-unicode-language-and-locale-identifiers-unicode-locale-identifier-item-8"></a> **However, it also**: However, it also functions (with few exceptions) as a language identifier, and accesses language-based data.

* <a id="core-unicode-language-and-locale-identifiers-unicode-locale-identifier-item-9"></a> **Except where it**: Except where it would be unclear, this document uses the term "locale" data loosely to encompass both types of data: for more information, see _[Language and Locale IDs](#Language_and_Locale_IDs)_.
...
* <a id="core-unicode-language-and-locale-identifiers-unicode-locale-identifier-item-10"></a> **As for terminology**: As for terminology, the term _code_ may also be used instead of "subtag", and "territory" instead of "region".

* <a id="core-unicode-language-and-locale-identifiers-unicode-locale-identifier-item-11"></a> **The primary language**: The primary language subtag is also called the _base language code_.

* <a id="core-unicode-language-and-locale-identifiers-unicode-locale-identifier-item-12"></a> **For example, the**: For example, the base language code for "en-US" (American English) is "en" (English).

* <a id="core-unicode-language-and-locale-identifiers-unicode-locale-identifier-item-13"></a> **The _type_ may**: The _type_ may also be referred to as a _value_ or _key-value_.


* <a id="core-unicode-language-and-locale-identifiers-unicode-locale-identifier-item-14"></a> **All identifier field**: All identifier field values are case-insensitive.

* <a id="core-unicode-language-and-locale-identifiers-unicode-locale-identifier-item-15"></a> **Although case distinctions**: Although case distinctions do not carry any special meaning, an implementation of LDML should use the casing recommendations in [[BCP47](#BCP47)], especially when a Unicode locale identifier is used for locale data exchange in software protocols.
...
#### Notes <a id="core-unicode-locale-data-markup-language-ldml-unicode-language-and-locale-identifiers-unicode-locale-identifier-notes"></a>

* <a id="core-unicode-language-and-locale-identifiers-unicode-locale-identifier-note-1"></a> **Note 1**: The current version of CLDR data uses _Unicode **CLDR** locale identifiers_ for backward compatibility. This might be changed in future CLDR releases.

#### <a name="Canonical_Unicode_Locale_Identifiers" id="core-unicode-locale-data-markup-language-ldml-unicode-language-and-locale-identifiers-unicode-locale-identifier-canonical-unicode-locale-identifiers" href="#Canonical_Unicode_Locale_Identifiers">Canonical Unicode Locale Identifiers</a>
...
* <a id="core-unicode-language-and-locale-identifiers-unicode-locale-identifier-canonical-unicode-locale-identifiers-item-1"></a> **For example, the**: For example, the canonical form of "en-u-foo-bar-nu-thai-ca-buddhist-kk-true" is "en-u-bar-foo-ca-buddhist-kk-nu-thai".

* <a id="core-unicode-language-and-locale-identifiers-unicode-locale-identifier-canonical-unicode-locale-identifiers-item-2"></a> **The attributes `"foo**: The attributes `"foo"` and `"bar"` in this example are provided only for illustration; no attribute subtags are defined by the current CLDR specification.



##### Notes <a id="core-unicode-locale-data-markup-language-ldml-unicode-language-and-locale-identifiers-unicode-locale-identifier-canonical-unicode-locale-identifiers-notes"></a>

* <a id="core-unicode-language-and-locale-identifiers-unicode-locale-identifier-canonical-unicode-locale-identifiers-note-1"></a> **Note 1**: Some people may wonder why CLDR uses alphabetical order for variants, rather than the ordering in [Section 4.1](https://www.rfc-editor.org/rfc/rfc5646.html#section-4.1) of BCP 47. Here are the considerations that lead to that decision:
...
* <a id="core-unicode-language-and-locale-identifiers-unicode-locale-identifier-canonical-unicode-locale-identifiers-notes-item-1"></a> **A [`unicode_locale_id`](#unicode_locale_id) is**: A [`unicode_locale_id`](#unicode_locale_id) is in _canonical form_ when it has canonical syntax and contains no aliased subtags.

* <a id="core-unicode-language-and-locale-identifiers-unicode-locale-identifier-canonical-unicode-locale-identifiers-notes-item-2"></a> **A [`unicode_locale_id`](#unicode_locale_id) can**: A [`unicode_locale_id`](#unicode_locale_id) can be transformed into canonical form according to [Annex C.

* <a id="core-unicode-language-and-locale-identifiers-unicode-locale-identifier-canonical-unicode-locale-identifiers-notes-item-3"></a> **LocaleId Canonicalization](#LocaleId_Canonicalization**: LocaleId Canonicalization](#LocaleId_Canonicalization).
...
* <a id="core-unicode-language-and-locale-identifiers-unicode-locale-identifier-canonical-unicode-locale-identifiers-notes-item-4"></a> **The equivalence relationship**: The equivalence relationship may change over time, such as when subtags are deprecated or likely subtag mappings change.

* <a id="core-unicode-language-and-locale-identifiers-unicode-locale-identifier-canonical-unicode-locale-identifiers-notes-item-5"></a> **For example, if**: For example, if two countries were to merge, then various subtags would become deprecated.

* <a id="core-unicode-language-and-locale-identifiers-unicode-locale-identifier-canonical-unicode-locale-identifiers-notes-item-6"></a> **These kinds of**: These kinds of changes are generally very infrequent.



### <a name="BCP_47_Conformance" id="core-unicode-locale-data-markup-language-ldml-unicode-language-and-locale-identifiers-bcp-47-conformance" href="#BCP_47_Conformance">BCP 47 Conformance</a>
...
#### <a name="BCP_47_Language_Tag_Conversion" id="core-unicode-locale-data-markup-language-ldml-unicode-language-and-locale-identifiers-bcp-47-conformance-bcp-47-language-tag-conversion" href="#BCP_47_Language_Tag_Conversion">BCP 47 Language Tag Conversion</a>
...
* <a id="core-unicode-language-and-locale-identifiers-bcp-47-conformance-bcp-47-language-tag-conversion-item-1"></a> **The result is**: The result is a Unicode BCP 47 locale identifier, in canonical form.

* <a id="core-unicode-language-and-locale-identifiers-bcp-47-conformance-bcp-47-language-tag-conversion-item-2"></a> **It is both**: It is both a BCP 47 language tag and a Unicode locale identifier.

* <a id="core-unicode-language-and-locale-identifiers-bcp-47-conformance-bcp-47-language-tag-conversion-item-3"></a> **Because the process**: Because the process maps from all BCP 47 language tags into a subset of BCP 47 language tags, the format changes are not reversible, much as a lowercase transformation of the string “McGowan” is not reversible.
...
##### <a name="Unicode_Locale_Identifier_CLDR_to_BCP_47" id="core-unicode-locale-data-markup-language-ldml-unicode-language-and-locale-identifiers-bcp-47-conformance-bcp-47-language-tag-conversion-unicode-locale-identifier-cldr-to-bcp-47" href="#Unicode_Locale_Identifier_CLDR_to_BCP_47">Unicode Locale Identifier: CLDR to BCP 47</a>
...
##### <a name="Unicode_Locale_Identifier_BCP_47_to_CLDR" id="core-unicode-locale-data-markup-language-ldml-unicode-language-and-locale-identifiers-bcp-47-conformance-bcp-47-language-tag-conversion-unicode-locale-identifier-bcp-47-to-cldr" href="#Unicode_Locale_Identifier_BCP_47_to_CLDR">Unicode Locale Identifier: BCP 47 to CLDR</a>
...
### <a name="Field_Definitions" id="core-unicode-locale-data-markup-language-ldml-unicode-language-and-locale-identifiers-language-identifier-field-definitions" href="#Field_Definitions">Language Identifier Field Definitions</a>

Unicode language and locale identifier field values are provided in the following table.

#### Notes <a id="core-unicode-locale-data-markup-language-ldml-unicode-language-and-locale-identifiers-language-identifier-field-definitions-notes"></a>

* <a id="core-unicode-language-and-locale-identifiers-language-identifier-field-definitions-note-1"></a> **Note**: Note that some private-use BCP 47 field values are given specific meanings in CLDR. While field values are based on [[BCP47](#BCP47)] subtag values, their validity status in CLDR is specified by means of machine-readable files in the [common/validity/](https://github.com/unicode-org/cldr/tree/main/common/validity) subdirectory, such as language.xml. For the format of those files and more information, see _[Validity Data](#Validity_Data)_.

#### <a name="unicode_language_subtag_validity" id="core-unicode-locale-data-markup-language-ldml-unicode-language-and-locale-identifiers-language-identifier-field-definitions-unicodelanguagesubtag-also-known-as-a-unicode-base-language-code" href="#unicode_language_subtag_validity">`unicode_language_subtag` (also known as a _Unicode base language code_)</a>
...
* <a id="core-unicode-language-and-locale-identifiers-language-identifier-field-definitions-unicodelanguagesubtag-also-known-as-a-unicode-base-language-code-item-1"></a> **ISO 639-3 introduces**: ISO 639-3 introduces the notion of "macrolanguages", where certain ISO 639-1 or ISO 639-2 codes are given broad semantics, and additional codes are given for the narrower semantics.

* <a id="core-unicode-language-and-locale-identifiers-language-identifier-field-definitions-unicodelanguagesubtag-also-known-as-a-unicode-base-language-code-item-2"></a> **For backwards compatibility**: For backwards compatibility, Unicode language identifiers retain use of the narrower semantics for these codes.

* <a id="core-unicode-language-and-locale-identifiers-language-identifier-field-definitions-unicodelanguagesubtag-also-known-as-a-unicode-base-language-code-item-3"></a> **For example**: For example:
...
* <a id="core-unicode-language-and-locale-identifiers-language-identifier-field-definitions-unicodelanguagesubtag-also-known-as-a-unicode-base-language-code-item-4"></a> **If a language**: If a language subtag matches the `type` attribute of a `languageAlias` element, then the replacement value is used instead.

* <a id="core-unicode-language-and-locale-identifiers-language-identifier-field-definitions-unicodelanguagesubtag-also-known-as-a-unicode-base-language-code-item-5"></a> **For example, because**: For example, because "swh" occurs in `<languageAlias type="swh" replacement="sw" />` , "sw" must be used instead of "swh".

* <a id="core-unicode-language-and-locale-identifiers-language-identifier-field-definitions-unicodelanguagesubtag-also-known-as-a-unicode-base-language-code-item-6"></a> **Thus Unicode language**: Thus Unicode language identifiers use "ar-EG" for Standard Arabic (Egypt), not "arb-EG"; they use "zh-TW" for Mandarin Chinese (Taiwan), not "cmn-TW".
...
#### <a name="unicode_script_subtag_validity" id="core-unicode-locale-data-markup-language-ldml-unicode-language-and-locale-identifiers-language-identifier-field-definitions-unicodescriptsubtag-also-known-as-a-unicode-script-code" href="#unicode_script_subtag_validity">`unicode_script_subtag` (also known as a _Unicode script code_)</a>
...
#### <a name="unicode_region_subtag_validity" id="core-unicode-locale-data-markup-language-ldml-unicode-language-and-locale-identifiers-language-identifier-field-definitions-unicoderegionsubtag-also-known-as-a-unicode-region-code-or-a-unicode-territory-code" href="#unicode_region_subtag_validity">`unicode_region_subtag` (also known as a _Unicode region code,_ or a _Unicode territory code_)</a>
...
* <a id="core-unicode-language-and-locale-identifiers-language-identifier-field-definitions-unicoderegionsubtag-also-known-as-a-unicode-region-code-or-a-unicode-territory-code-item-1"></a> **The private use**: The private use subtags listed as **excluded** in _[Private Use Codes](#Private_Use_Codes)_ will normally never be given specific semantics in Unicode identifiers, and are thus safe for use for other purposes by other applications.

* <a id="core-unicode-language-and-locale-identifiers-language-identifier-field-definitions-unicoderegionsubtag-also-known-as-a-unicode-region-code-or-a-unicode-territory-code-item-2"></a> **However, LDML may**: However, LDML may follow widespread industry practice in the use of some of these codes, such as for XK.
...
#### <a name="unicode_variant_subtag_validity" id="core-unicode-locale-data-markup-language-ldml-unicode-language-and-locale-identifiers-language-identifier-field-definitions-unicodevariantsubtag-also-known-as-a-unicode-language-variant-code" href="#unicode_variant_subtag_validity">`unicode_variant_subtag` (also known as a _Unicode language variant code_)</a>

* <a id="core-unicode-language-and-locale-identifiers-language-identifier-field-definitions-unicodevariantsubtag-also-known-as-a-unicode-language-variant-code-item-1"></a> **Subtags in the**: Subtags in the variant.xml file (see _[Validity Data](#Validity_Data)_).

* <a id="core-unicode-language-and-locale-identifiers-language-identifier-field-definitions-unicodevariantsubtag-also-known-as-a-unicode-language-variant-code-item-2"></a> **These are based**: These are based on [[BCP47](#BCP47)] subtag values marked as **Type: variant**.

* <a id="core-unicode-language-and-locale-identifiers-language-identifier-field-definitions-unicodevariantsubtag-also-known-as-a-unicode-language-variant-code-item-3"></a> **The sequence of**: The sequence of variant tags must not have any duplicates: thus de-1996-fonipa-1996 is invalid, while de-1996-fonipa and de-fonipa-1996 are both valid.
...
### <a name="Special_Codes" id="core-unicode-locale-data-markup-language-ldml-unicode-language-and-locale-identifiers-special-codes" href="#Special_Codes">Special Codes</a>

#### <a name="Unknown_or_Invalid_Identifiers" id="core-unicode-locale-data-markup-language-ldml-unicode-language-and-locale-identifiers-special-codes-unknown-or-invalid-identifiers" href="#Unknown_or_Invalid_Identifiers">Unknown or Invalid Identifiers</a>

* <a id="core-unicode-language-and-locale-identifiers-special-codes-unknown-or-invalid-identifiers-item-1"></a> **The following identifiers**: The following identifiers are used to indicate an unknown or invalid code in Unicode language and locale identifiers.

* <a id="core-unicode-language-and-locale-identifiers-special-codes-unknown-or-invalid-identifiers-item-2"></a> **For Unicode identifiers**: For Unicode identifiers, the region code uses a private use ISO 3166 code, and Time Zone code uses an additional code; the others are defined by the relevant standards.

* <a id="core-unicode-language-and-locale-identifiers-special-codes-unknown-or-invalid-identifiers-item-3"></a> **When these codes**: When these codes are used in APIs connected with Unicode identifiers, the meaning is that either there was no identifier available, or that at some point an input identifier value was determined to be invalid or ill-formed.
...
#### <a name="Numeric_Codes" id="core-unicode-locale-data-markup-language-ldml-unicode-language-and-locale-identifiers-special-codes-numeric-codes" href="#Numeric_Codes">Numeric Codes</a>

* <a id="core-unicode-language-and-locale-identifiers-special-codes-numeric-codes-item-1"></a> **For region codes**: For region codes, ISO and the UN establish a mapping to three-letter codes and numeric codes.

* <a id="core-unicode-language-and-locale-identifiers-special-codes-numeric-codes-item-2"></a> **However, this does**: However, this does not extend to the private use codes, which are the codes 900-999 (total: 100), and AAA, QMA-QZZ, XAA-XZZ, and ZZZ (total: 1092).

* <a id="core-unicode-language-and-locale-identifiers-special-codes-numeric-codes-item-3"></a> **Unicode identifiers supply**: Unicode identifiers supply a standard mapping to these: for the numeric codes, it uses the top of the numeric private use range; for the 3-letter codes it doubles the final letter.

* <a id="core-unicode-language-and-locale-identifiers-special-codes-numeric-codes-item-4"></a> **These are the**: These are the resulting mappings for all of the private use region codes:
...
#### <a name="Private_Use_Codes" id="core-unicode-locale-data-markup-language-ldml-unicode-language-and-locale-identifiers-special-codes-private-use-codes" href="#Private_Use_Codes">Private Use Codes</a>
...
### <a name="u_Extension" id="core-unicode-locale-data-markup-language-ldml-unicode-language-and-locale-identifiers-unicode-bcp-47-u-extension" href="#u_Extension">Unicode BCP 47 U Extension</a>
...
* <a id="core-unicode-language-and-locale-identifiers-unicode-bcp-47-u-extension-item-1"></a> **The Unicode Consortium**: The Unicode Consortium has registered and is the maintaining authority for two BCP 47 language tag extensions: the extension 'u' for Unicode locale extension [[RFC6067](#RFC6067)] and extension 't' for transformed content [[RFC6497](#RFC6497)].

* <a id="core-unicode-language-and-locale-identifiers-unicode-bcp-47-u-extension-item-2"></a> **The Unicode BCP**: The Unicode BCP 47 extension data defines the complete list of valid subtags.


* <a id="core-unicode-language-and-locale-identifiers-unicode-bcp-47-u-extension-item-3"></a> **These subtags are**: These subtags are all in lowercase (that is the canonical casing for these subtags), however, subtags are case-insensitive and casing does not carry any specific meaning.

* <a id="core-unicode-language-and-locale-identifiers-unicode-bcp-47-u-extension-item-4"></a> **All subtags within**: All subtags within the Unicode extensions are alphanumeric characters in length of two to eight that meet the rule `extension` in the [[BCP47](#BCP47)].
...
#### <a name="Key_And_Type_Definitions_" id="core-unicode-locale-data-markup-language-ldml-unicode-language-and-locale-identifiers-unicode-bcp-47-u-extension-key-and-type-definitions" href="#Key_And_Type_Definitions_">Key And Type Definitions</a>
...
* <a id="core-unicode-language-and-locale-identifiers-unicode-bcp-47-u-extension-key-and-type-definitions-item-1"></a> **For the complete**: For the complete list of valid keys and types defined for Unicode locale extensions, see [U Extension Data Files](#Unicode_Locale_Extension_Data_Files).

* <a id="core-unicode-language-and-locale-identifiers-unicode-bcp-47-u-extension-key-and-type-definitions-item-2"></a> **For information on**: For information on the process for adding new _key_/_type_, see [[LocaleProject](#localeProject)].


Most type values are represented by a single subtag in the current version of CLDR. There are exceptions, such as types used for key "ca" (calendar) and "kr" (collation reordering). If the type is not included, then the type value "true" is assumed.

##### Notes <a id="core-unicode-locale-data-markup-language-ldml-unicode-language-and-locale-identifiers-unicode-bcp-47-u-extension-key-and-type-definitions-notes"></a>

* <a id="core-unicode-language-and-locale-identifiers-unicode-bcp-47-u-extension-key-and-type-definitions-note-1"></a> **Note**: Note that the default for key with a possible "true" value is often "false", but may not always be. Note also that "true"/"True" is not a valid script code, since [the ISO 15924 Registration Authority has exceptionally reserved it](https://www.unicode.org/iso15924/codelists.html), which means that it will not be assigned for any purpose.
...
###### Table: Key/Type Definitions <a id="core-unicode-locale-data-markup-language-ldml-unicode-language-and-locale-identifiers-unicode-bcp-47-u-extension-key-and-type-definitions-notes-table-keytype-definitions"></a>
...
#### <a name="Numbering%20System%20Data" id="core-unicode-locale-data-markup-language-ldml-unicode-language-and-locale-identifiers-unicode-bcp-47-u-extension-numbering-system-data" href="#Numbering%20System%20Data">Numbering System Data</a>

* <a id="core-unicode-language-and-locale-identifiers-unicode-bcp-47-u-extension-numbering-system-data-item-1"></a> **LDML supports multiple**: LDML supports multiple numbering systems.

* <a id="core-unicode-language-and-locale-identifiers-unicode-bcp-47-u-extension-numbering-system-data-item-2"></a> **The identifiers for**: The identifiers for those numbering systems are defined in the file **bcp47/number.xml**.

* <a id="core-unicode-language-and-locale-identifiers-unicode-bcp-47-u-extension-numbering-system-data-item-3"></a> **For example, for**: For example, for the latest version of the data see [bcp47/number.xml](https://github.com/unicode-org/cldr/blob/main/common/bcp47/number.xml).


* <a id="core-unicode-language-and-locale-identifiers-unicode-bcp-47-u-extension-numbering-system-data-item-4"></a> **Details about those**: Details about those numbering systems are defined in **supplemental/numberingSystems.xml**.

* <a id="core-unicode-language-and-locale-identifiers-unicode-bcp-47-u-extension-numbering-system-data-item-5"></a> **For example, for**: For example, for the latest version of the data see [supplemental/numberingSystems.xml](https://github.com/unicode-org/cldr/blob/main/common/supplemental/numberingSystems.xml).
...
#### <a name="Time_Zone_Identifiers" id="core-unicode-locale-data-markup-language-ldml-unicode-language-and-locale-identifiers-unicode-bcp-47-u-extension-time-zone-identifiers" href="#Time_Zone_Identifiers">Time Zone Identifiers</a>

* <a id="core-unicode-language-and-locale-identifiers-unicode-bcp-47-u-extension-time-zone-identifiers-item-1"></a> **LDML inherits time**: LDML inherits time zone IDs from the tz database [[Olson](#Olson)].

* <a id="core-unicode-language-and-locale-identifiers-unicode-bcp-47-u-extension-time-zone-identifiers-item-2"></a> **Because these IDs**: Because these IDs from the tz database do not satisfy the BCP 47 language subtag syntax requirements, CLDR defines short identifiers for the use in the Unicode locale extension.

* <a id="core-unicode-language-and-locale-identifiers-unicode-bcp-47-u-extension-time-zone-identifiers-item-3"></a> **The short identifiers**: The short identifiers are defined in the file **common/bcp47/timezone.xml**.


* <a id="core-unicode-language-and-locale-identifiers-unicode-bcp-47-u-extension-time-zone-identifiers-item-4"></a> **The short identifiers**: The short identifiers use UN/LOCODE [[LOCODE](#LOCODE)] (excluding a space character) codes where possible.

* <a id="core-unicode-language-and-locale-identifiers-unicode-bcp-47-u-extension-time-zone-identifiers-item-5"></a> **For example, the**: For example, the short identifier for "America/Los_Angeles" is "uslax" (the LOCODE for Los Angeles, US is "US LAX").

* <a id="core-unicode-language-and-locale-identifiers-unicode-bcp-47-u-extension-time-zone-identifiers-item-6"></a> **Identifiers of length**: Identifiers of length not equal to 5 are used where there is no corresponding UN/LOCODE, such as "usnavajo" for "America/Shiprock", or "utcw01" for "Etc/GMT+1", so that they do not overlap with future UN/LOCODE.


* <a id="core-unicode-language-and-locale-identifiers-unicode-bcp-47-u-extension-time-zone-identifiers-item-7"></a> **The first two**: The first two letters of a length 5 short identifier double as the time zone's associated region, unless the time zone has an explicit `region` attribute that overrides this.

* <a id="core-unicode-language-and-locale-identifiers-unicode-bcp-47-u-extension-time-zone-identifiers-item-8"></a> **Short identifiers of**: Short identifiers of length not equal to 5 are not associated with a region, unless the time zone has an explicit `region` attribute.

* <a id="core-unicode-language-and-locale-identifiers-unicode-bcp-47-u-extension-time-zone-identifiers-item-9"></a> **Short identifiers are**: Short identifiers are stable, meaning that they will not change no matter what changes happen in the base standard.

* <a id="core-unicode-language-and-locale-identifiers-unicode-bcp-47-u-extension-time-zone-identifiers-item-10"></a> **For example, the**: For example, the short identifier for "America/Curacao" is still "ancur", with a `region="CW"` override, instead of the current LOCODE "cwcur".
...
* <a id="core-unicode-language-and-locale-identifiers-unicode-bcp-47-u-extension-time-zone-identifiers-item-11"></a> **Although the short**: Although the short time zone identifiers are guaranteed to be stable, the preferred IDs in the tz database (as those found in **zone.tab** file) might be changed time to time.

* <a id="core-unicode-language-and-locale-identifiers-unicode-bcp-47-u-extension-time-zone-identifiers-item-12"></a> **For example, "Asia/Calcutta**: For example, "Asia/Calcutta" was replaced with "Asia/Kolkata" and moved to **backward** file in the tz database.

* <a id="core-unicode-language-and-locale-identifiers-unicode-bcp-47-u-extension-time-zone-identifiers-item-13"></a> **CLDR contains locale**: CLDR contains locale data using a time zone ID from the tz database as the key, stability of the IDs is critical.


* <a id="core-unicode-language-and-locale-identifiers-unicode-bcp-47-u-extension-time-zone-identifiers-item-14"></a> **To maintain the**: To maintain the stability of "long" IDs (for those inherited from the tz database), a special rule applied to the `alias` attribute in the `<type>` element for "tz" - the first "long" ID is the CLDR canonical "long" time zone ID.

* <a id="core-unicode-language-and-locale-identifiers-unicode-bcp-47-u-extension-time-zone-identifiers-item-15"></a> **In addition to**: In addition to this, `iana` attribute specifies the preferred ID in the tz database if it's different from the CLDR canonical "long" ID.
...
* <a id="core-unicode-language-and-locale-identifiers-unicode-bcp-47-u-extension-time-zone-identifiers-item-16"></a> **Above `` element**: Above `<type>` element defines the short time zone ID "inccu" (for the use in the Unicode locale extension), corresponding _CLDR canonical "long" ID_ "Asia/Calcutta", and an alias "Asia/Kolkata".

* <a id="core-unicode-language-and-locale-identifiers-unicode-bcp-47-u-extension-time-zone-identifiers-item-17"></a> **In the tz**: In the tz database, the preferred ID for this time zone is "Asia/Kolkata".
...
#### <a name="Unicode_Locale_Extension_Data_Files" id="core-unicode-locale-data-markup-language-ldml-unicode-language-and-locale-identifiers-unicode-bcp-47-u-extension-u-extension-data-files" href="#Unicode_Locale_Extension_Data_Files">U Extension Data Files</a>

* <a id="core-unicode-language-and-locale-identifiers-unicode-bcp-47-u-extension-u-extension-data-files-item-1"></a> **The 'u' extension**: The 'u' extension data is stored in multiple XML files located under common/bcp47 directory in CLDR.

* <a id="core-unicode-language-and-locale-identifiers-unicode-bcp-47-u-extension-u-extension-data-files-item-2"></a> **Each file contains**: Each file contains the locale extension key/type values and their backward compatibility mappings appropriate for a particular domain.

* <a id="core-unicode-language-and-locale-identifiers-unicode-bcp-47-u-extension-u-extension-data-files-item-3"></a> **common/bcp47/collation.xml](https://github.com/unicode-org/cldr/blob/maint/maint-47/common/bcp47/collation.xml) contains key/type**: [common/bcp47/collation.xml](https://github.com/unicode-org/cldr/blob/maint/maint-47/common/bcp47/collation.xml) contains key/type values for collation, including optional collation parameters and valid type values for each key.
...
* <a id="core-unicode-language-and-locale-identifiers-unicode-bcp-47-u-extension-u-extension-data-files-item-4"></a> **> The key**: > The key or type name used by Unicode locale extension with ['u' extension syntax](#Unicode_locale_identifier) or the 't' extensions syntax.

* <a id="core-unicode-language-and-locale-identifiers-unicode-bcp-47-u-extension-u-extension-data-files-item-5"></a> **When _alias_ below**: When _alias_ below is absent, this name can be also used with the old style ["@key=type" syntax](#Old_Locale_Extension_Syntax).

>
* <a id="core-unicode-language-and-locale-identifiers-unicode-bcp-47-u-extension-u-extension-data-files-item-6"></a> **> Most type**: > Most type names are **literal type names**, which match exactly the same value.

* <a id="core-unicode-language-and-locale-identifiers-unicode-bcp-47-u-extension-u-extension-data-files-item-7"></a> **All of these**: All of these have at least one lowercase letter, such as "buddhist".

* <a id="core-unicode-language-and-locale-identifiers-unicode-bcp-47-u-extension-u-extension-data-files-item-8"></a> **There are a**: There are a small number of **indirect type names**, such as "RG_KEY_VALUE".

* <a id="core-unicode-language-and-locale-identifiers-unicode-bcp-47-u-extension-u-extension-data-files-item-9"></a> **These have no**: These have no lowercase letters.

* <a id="core-unicode-language-and-locale-identifiers-unicode-bcp-47-u-extension-u-extension-data-files-item-10"></a> **The interpretation of**: The interpretation of each one is listed below.
...
>
* <a id="core-unicode-language-and-locale-identifiers-unicode-bcp-47-u-extension-u-extension-data-files-item-11"></a> **> In the**: > In the current version of CLDR, the type "CODEPOINTS" is only used for the deprecated locale extension key "vt" (variableTop).

* <a id="core-unicode-language-and-locale-identifiers-unicode-bcp-47-u-extension-u-extension-data-files-item-12"></a> **The subtags forming**: The subtags forming the type for "vt" represent an arbitrary string of characters.

* <a id="core-unicode-language-and-locale-identifiers-unicode-bcp-47-u-extension-u-extension-data-files-item-13"></a> **There is no**: There is no formal limit in the number of characters, although practically anything above 1 will be rare, and anything longer than 4 might be useless.

* <a id="core-unicode-language-and-locale-identifiers-unicode-bcp-47-u-extension-u-extension-data-files-item-14"></a> **Repetition is allowed**: Repetition is allowed, for example, 0061-0061 ("aa") is a Valid type value for "vt", since the sequence may be a collating element.

* <a id="core-unicode-language-and-locale-identifiers-unicode-bcp-47-u-extension-u-extension-data-files-item-15"></a> **Order is vital**: Order is vital: 0061-0062 ("ab") is different than 0062-0061 ("ba").


##### Notes <a id="core-unicode-locale-data-markup-language-ldml-unicode-language-and-locale-identifiers-unicode-bcp-47-u-extension-u-extension-data-files-notes"></a>

* <a id="core-unicode-language-and-locale-identifiers-unicode-bcp-47-u-extension-u-extension-data-files-note-1"></a> **Note**: Note that for variableTop any character sequence must be a contraction which yields exactly one primary weight.
>
> For example,
>
...
>
* <a id="core-unicode-language-and-locale-identifiers-unicode-bcp-47-u-extension-u-extension-data-files-notes-item-1"></a> **> The type**: > The type name **"REORDER_CODE"** is reserved for reordering block names (e.g.

* <a id="core-unicode-language-and-locale-identifiers-unicode-bcp-47-u-extension-u-extension-data-files-notes-item-2"></a> **latn", "digit" and**: "latn", "digit" and "others") defined in the _[Root Collation](tr35-collation.md#Root_Collation)_.

* <a id="core-unicode-language-and-locale-identifiers-unicode-bcp-47-u-extension-u-extension-data-files-notes-item-3"></a> **The type "REORDER_CODE**: The type "REORDER_CODE" is used for locale extension key "kr" (colReorder).

* <a id="core-unicode-language-and-locale-identifiers-unicode-bcp-47-u-extension-u-extension-data-files-notes-item-4"></a> **The value of**: The value of type for "kr" is represented by one or more reordering block names such as "latn-digit".

* <a id="core-unicode-language-and-locale-identifiers-unicode-bcp-47-u-extension-u-extension-data-files-notes-item-5"></a> **For more information**: For more information, see [Collation: _Collation Reordering_](tr35-collation.md#Script_Reordering) .
...
>
* <a id="core-unicode-language-and-locale-identifiers-unicode-bcp-47-u-extension-u-extension-data-files-notes-item-6"></a> **> The type**: > The type name **"SCRIPT_CODE"** is reserved for [`unicode_script_subtag`](#unicode_script_subtag) values (e.g.

* <a id="core-unicode-language-and-locale-identifiers-unicode-bcp-47-u-extension-u-extension-data-files-notes-item-7"></a> **thai", "laoo**: "thai", "laoo").

* <a id="core-unicode-language-and-locale-identifiers-unicode-bcp-47-u-extension-u-extension-data-files-notes-item-8"></a> **The type "SCRIPT_CODE**: The type "SCRIPT_CODE" is used for locale extension key "dx".

* <a id="core-unicode-language-and-locale-identifiers-unicode-bcp-47-u-extension-u-extension-data-files-notes-item-9"></a> **The value of**: The value of type for "dx" is represented by one or more SCRIPT_CODEs, such as "thai-laoo".

>
> ##### <a name="SUBDIVISION_CODE" href="#SUBDIVISION_CODE">SUBDIVISION_CODE</a>
>
* <a id="core-unicode-language-and-locale-identifiers-unicode-bcp-47-u-extension-u-extension-data-files-notes-item-10"></a> **> The type**: > The type name **"SUBDIVISION_CODE"** is reserved for subdivision codes in the format required by the "sd" key; this is a subdivision code from the idValidity data in common/validity/subdivision.xml, excluding those with idStatus='unknown'.

* <a id="core-unicode-language-and-locale-identifiers-unicode-bcp-47-u-extension-u-extension-data-files-notes-item-11"></a> **Codes with idStatus='deprecated**: Codes with idStatus='deprecated' should not be generated, and those with idStatus='private_use' are only to be used with prior agreement.

>
> ##### <a name="PRIVATE_USE" href="#PRIVATE_USE">PRIVATE_USE</a>
>
* <a id="core-unicode-language-and-locale-identifiers-unicode-bcp-47-u-extension-u-extension-data-files-notes-item-12"></a> **> The type**: > The type name **"PRIVATE_USE"** is reserved for private use types.

* <a id="core-unicode-language-and-locale-identifiers-unicode-bcp-47-u-extension-u-extension-data-files-notes-item-13"></a> **A valid type**: A valid type value is composed of one or more subtags separated by hyphens and each subtag consists of three to eight ASCII alphanumeric characters.

* <a id="core-unicode-language-and-locale-identifiers-unicode-bcp-47-u-extension-u-extension-data-files-notes-item-14"></a> **In the current**: In the current version of CLDR, **"PRIVATE_USE"** is only used for transform extension "x0".
...
* <a id="core-unicode-language-and-locale-identifiers-unicode-bcp-47-u-extension-u-extension-data-files-notes-item-15"></a> **> | `incremental**: > | `incremental` | Multiple type values are allowed, but only if a prefix is also present, and the sequence is explicitly listed.

* <a id="core-unicode-language-and-locale-identifiers-unicode-bcp-47-u-extension-u-extension-data-files-notes-item-16"></a> **Each successive type**: Each successive type value indicates a refinement of its prefix.

* <a id="core-unicode-language-and-locale-identifiers-unicode-bcp-47-u-extension-u-extension-data-files-notes-item-17"></a> **For example:`<key name="ca**: For example:<br/>`<key name="ca" description="Calendar algorithm key" valueType="incremental">`<br/>`    <type name="islamic" description="Islamic calendar"/>`<br/>`    <type name="islamic-umalqura" description="Islamic calendar, Umm al-Qura"/>`<br/>Thus _ca-islamic-umalqura_ is valid.

* <a id="core-unicode-language-and-locale-identifiers-unicode-bcp-47-u-extension-u-extension-data-files-notes-item-18"></a> **However, _ca-gregory-japanese_ is**: However, _ca-gregory-japanese_ is not valid, because "gregory-japanese" is not listed as a type. |
...
>
* <a id="core-unicode-language-and-locale-identifiers-unicode-bcp-47-u-extension-u-extension-data-files-notes-item-19"></a> **> The alias**: > The alias is a key or type name used by Unicode locale extensions with the old ["@key=type" syntax](#Old_Locale_Extension_Syntax).

* <a id="core-unicode-language-and-locale-identifiers-unicode-bcp-47-u-extension-u-extension-data-files-notes-item-20"></a> **The attribute value**: The attribute value for type may contain multiple names delimited by ASCII space characters.

* <a id="core-unicode-language-and-locale-identifiers-unicode-bcp-47-u-extension-u-extension-data-files-notes-item-21"></a> **Of those aliases**: Of those aliases, the first name is the preferred value.
...
* <a id="core-unicode-language-and-locale-identifiers-unicode-bcp-47-u-extension-u-extension-data-files-notes-item-22"></a> **It is strongly**: It is strongly recommended that all API methods accept all possible aliases for keywords and types, but generate the canonical form.

* <a id="core-unicode-language-and-locale-identifiers-unicode-bcp-47-u-extension-u-extension-data-files-notes-item-23"></a> **For example, "ar-u-ca-islamicc**: For example, "ar-u-ca-islamicc" would be equivalent to "ar-u-ca-islamic-civil" on input, but the latter should be output.

* <a id="core-unicode-language-and-locale-identifiers-unicode-bcp-47-u-extension-u-extension-data-files-notes-item-24"></a> **The one exception**: The one exception is where an alias would only be well-formed with the old syntax, such as "gregorian" (for "gregory").
...
#### <a name="Unicode_Subdivision_Codes" id="core-unicode-locale-data-markup-language-ldml-unicode-language-and-locale-identifiers-unicode-bcp-47-u-extension-subdivision-codes" href="#Unicode_Subdivision_Codes">Subdivision Codes</a>

* <a id="core-unicode-language-and-locale-identifiers-unicode-bcp-47-u-extension-subdivision-codes-item-1"></a> **The subdivision codes**: The subdivision codes designate a subdivision of a country or region.

* <a id="core-unicode-language-and-locale-identifiers-unicode-bcp-47-u-extension-subdivision-codes-item-2"></a> **They are called**: They are called various names, such as a _state_ in the United States, or a _province_ in Canada.

* <a id="core-unicode-language-and-locale-identifiers-unicode-bcp-47-u-extension-subdivision-codes-item-3"></a> **The codes in**: The codes in CLDR are based on ISO 3166-2 subdivision codes.

* <a id="core-unicode-language-and-locale-identifiers-unicode-bcp-47-u-extension-subdivision-codes-item-4"></a> **The ISO codes**: The ISO codes have a region code followed by a hyphen, then a suffix consisting of 1..3 ASCII letters or digits.
...
* <a id="core-unicode-language-and-locale-identifiers-unicode-bcp-47-u-extension-subdivision-codes-item-5"></a> **CLDR has additional**: CLDR has additional subdivision codes.

* <a id="core-unicode-language-and-locale-identifiers-unicode-bcp-47-u-extension-subdivision-codes-item-6"></a> **These may start**: These may start with a 3-digit region code or use a suffix of 4 ASCII letters or digits, so they will not collide with the ISO codes.

* <a id="core-unicode-language-and-locale-identifiers-unicode-bcp-47-u-extension-subdivision-codes-item-7"></a> **Subdivision codes for**: Subdivision codes for unknown values are the region code plus "zzzz", such as "uszzzz" for an unknown subdivision of the US.

* <a id="core-unicode-language-and-locale-identifiers-unicode-bcp-47-u-extension-subdivision-codes-item-8"></a> **Other codes may**: Other codes may be added for stability.
...
##### <a name="Validity" id="core-unicode-locale-data-markup-language-ldml-unicode-language-and-locale-identifiers-unicode-bcp-47-u-extension-subdivision-codes-validity" href="#Validity">Validity</a>

* <a id="core-unicode-language-and-locale-identifiers-unicode-bcp-47-u-extension-subdivision-codes-validity-item-1"></a> **A [unicode_subdivision_id](#unicode_subdivision_id) is**: A [unicode_subdivision_id](#unicode_subdivision_id) is only valid when it is present in the subdivision.xml file as described in _[Validity Data](#Validity_Data)_.

* <a id="core-unicode-language-and-locale-identifiers-unicode-bcp-47-u-extension-subdivision-codes-validity-item-2"></a> **The data is**: The data is in a compressed form, and thus needs to be expanded before such a test is made.
...
* <a id="core-unicode-language-and-locale-identifiers-unicode-bcp-47-u-extension-subdivision-codes-validity-item-3"></a> **It is recommended**: It is recommended that a [unicode_locale_id](#unicode_locale_id) contain a [unicode_region_subtag](#unicode_region_subtag) if it contains a [unicode_subdivision_id](#unicode_subdivision_id) and the region would not be added by adding likely subtags.

* <a id="core-unicode-language-and-locale-identifiers-unicode-bcp-47-u-extension-subdivision-codes-validity-item-4"></a> **That produces better**: That produces better behavior if the [unicode_subdivision_id](#unicode_subdivision_id) is ignored by an implementation or if the language tag is truncated.
...
### <a name="BCP47_T_Extension" id="core-unicode-locale-data-markup-language-ldml-unicode-language-and-locale-identifiers-unicode-bcp-47-t-extension" href="#BCP47_T_Extension">Unicode BCP 47 T Extension</a>

* <a id="core-unicode-language-and-locale-identifiers-unicode-bcp-47-t-extension-item-1"></a> **The Unicode Consortium**: The Unicode Consortium has registered and is the maintaining authority for two BCP 47 language tag extensions: the extension 'u' for Unicode locale extension [[RFC6067](#RFC6067)] and extension 't' for transformed content [[RFC6497](#RFC6497)].

* <a id="core-unicode-language-and-locale-identifiers-unicode-bcp-47-t-extension-item-2"></a> **The Unicode BCP**: The Unicode BCP 47 extension data defines the complete list of valid subtags.

* <a id="core-unicode-language-and-locale-identifiers-unicode-bcp-47-t-extension-item-3"></a> **While the title**: While the title of the RFC is “Transformed Content”, the abstract makes it clear that the scope is broader than the term "transformed" might indicate to a casual reader: “including content that has been transliterated, transcribed, or translated, or _in some other way influenced by the source.

* <a id="core-unicode-language-and-locale-identifiers-unicode-bcp-47-t-extension-item-4"></a> **It also provides**: It also provides for additional information used for identification._”
...
* <a id="core-unicode-language-and-locale-identifiers-unicode-bcp-47-t-extension-item-5"></a> **These subtags are**: These subtags are all in lowercase (that is the canonical casing for these subtags), however, subtags are case-insensitive and casing does not carry any specific meaning.

* <a id="core-unicode-language-and-locale-identifiers-unicode-bcp-47-t-extension-item-6"></a> **All subtags within**: All subtags within the Unicode extensions are alphanumeric characters in length of two to eight that meet the rule `extension` in the [[BCP47](#BCP47)].
...
#### <a name="Transformed_Content_Data_File" id="core-unicode-locale-data-markup-language-ldml-unicode-language-and-locale-identifiers-unicode-bcp-47-t-extension-t-extension-data-files" href="#Transformed_Content_Data_File">T Extension Data Files</a>
...
### <a name="Compatibility_with_Older_Identifiers" id="core-unicode-locale-data-markup-language-ldml-unicode-language-and-locale-identifiers-compatibility-with-older-identifiers" href="#Compatibility_with_Older_Identifiers">Compatibility with Older Identifiers</a>
...
#### <a name="Old_Locale_Extension_Syntax" id="core-unicode-locale-data-markup-language-ldml-unicode-language-and-locale-identifiers-compatibility-with-older-identifiers-old-locale-extension-syntax" href="#Old_Locale_Extension_Syntax">Old Locale Extension Syntax</a>
...
* <a id="core-unicode-language-and-locale-identifiers-compatibility-with-older-identifiers-old-locale-extension-syntax-item-1"></a> **The new specification**: The new specification mandates keys to be two alphanumeric characters and types to be three to eight alphanumeric characters.

* <a id="core-unicode-language-and-locale-identifiers-compatibility-with-older-identifiers-old-locale-extension-syntax-item-2"></a> **As the result**: As the result, new codes were assigned to all existing keys and some types.

* <a id="core-unicode-language-and-locale-identifiers-compatibility-with-older-identifiers-old-locale-extension-syntax-item-3"></a> **For example, a**: For example, a new key "co" replaced the previous key "collation", a new type "phonebk" replaced the previous type "phonebook".

* <a id="core-unicode-language-and-locale-identifiers-compatibility-with-older-identifiers-old-locale-extension-syntax-item-4"></a> **However, the existing**: However, the existing collation type "big5han" already satisfied the new requirement, so no new type code was assigned to the type.

* <a id="core-unicode-language-and-locale-identifiers-compatibility-with-older-identifiers-old-locale-extension-syntax-item-5"></a> **All new keys**: All new keys and types introduced after LDML 1.7 satisfy the new requirement, so they do not have aliases dedicated for the old syntax, except time zone types.

* <a id="core-unicode-language-and-locale-identifiers-compatibility-with-older-identifiers-old-locale-extension-syntax-item-6"></a> **The conversion between**: The conversion between old types and new types can be done regardless of key, with one known exception (old type "traditional" is mapped to new type "trad" for collation and "traditio" for numbering system), and this relationship will be maintained in the future versions unless otherwise noted.


* <a id="core-unicode-language-and-locale-identifiers-compatibility-with-older-identifiers-old-locale-extension-syntax-item-7"></a> **The new specification**: The new specification introduced a new field `attribute` in addition to key/type pairs in the Unicode locale extension.

* <a id="core-unicode-language-and-locale-identifiers-compatibility-with-older-identifiers-old-locale-extension-syntax-item-8"></a> **When it is**: When it is necessary to map a new Unicode locale identifier with `attribute` field to a well-formed old locale identifier, a special key name _attribute_ with the value of entire `attribute` subtags in the new identifier is used.

* <a id="core-unicode-language-and-locale-identifiers-compatibility-with-older-identifiers-old-locale-extension-syntax-item-9"></a> **For example, a**: For example, a new identifier `ja-u-xxx-yyy-ca-japanese` is mapped to an old identifier `ja@attribute=xxx-yyy;calendar=japanese` .
...
#### <a name="Legacy_Variants" id="core-unicode-locale-data-markup-language-ldml-unicode-language-and-locale-identifiers-compatibility-with-older-identifiers-legacy-variants" href="#Legacy_Variants">Legacy Variants</a>

* <a id="core-unicode-language-and-locale-identifiers-compatibility-with-older-identifiers-legacy-variants-item-1"></a> **Old LDML specification**: Old LDML specification allowed codes other than registered [[BCP47](#BCP47)] variant subtags used in Unicode language and locale identifiers for representing variations of locale data.

* <a id="core-unicode-language-and-locale-identifiers-compatibility-with-older-identifiers-legacy-variants-item-2"></a> **Unicode locale identifiers**: Unicode locale identifiers including such variant codes can be converted to the new [[BCP47](#BCP47)] compatible identifiers by following the descriptions below:
...
###### Notes <a id="core-unicode-locale-data-markup-language-ldml-unicode-language-and-locale-identifiers-compatibility-with-older-identifiers-legacy-variants-notes"></a>

* <a id="core-unicode-language-and-locale-identifiers-compatibility-with-older-identifiers-legacy-variants-table-legacy-variant-mappings-note-1"></a> **Note**: Note that the mapping between `en_US_POSIX` and `en-US-u-va-posix` is a conversion process, not a canonicalization process.

#### <a name="Relation_to_OpenI18n" id="core-unicode-locale-data-markup-language-ldml-unicode-language-and-locale-identifiers-compatibility-with-older-identifiers-relation-to-openi18n" href="#Relation_to_OpenI18n">Relation to OpenI18n</a>
...
### <a name="Transmitting_Locale_Information" id="core-unicode-locale-data-markup-language-ldml-unicode-language-and-locale-identifiers-transmitting-locale-information" href="#Transmitting_Locale_Information">Transmitting Locale Information</a>

* <a id="core-unicode-language-and-locale-identifiers-transmitting-locale-information-item-1"></a> **In a world**: In a world of on-demand software components, with arbitrary connections between those components, it is important to get a sense of where localization should be done, and how to transmit enough information so that it can be done at that appropriate place.

* <a id="core-unicode-language-and-locale-identifiers-transmitting-locale-information-item-2"></a> **End-users need to**: End-users need to get messages localized to their languages, messages that not only contain a translation of text, but also contain variables such as date, time, number formats, and currencies formatted according to the users' conventions.

* <a id="core-unicode-language-and-locale-identifiers-transmitting-locale-information-item-3"></a> **The strategy for**: The strategy for doing the so-called _JIT localization_ is made up of two parts:


1. Store and transmit _neutral-format_ data wherever possible.
* <a id="core-unicode-language-and-locale-identifiers-transmitting-locale-information-item-4"></a> *** Neutral-format data**: * Neutral-format data is data that is kept in a standard format, no matter what the local user's environment is.

* <a id="core-unicode-language-and-locale-identifiers-transmitting-locale-information-item-5"></a> **Neutral-format is also**: Neutral-format is also (loosely) called _binary data_, even though it actually could be represented in many different ways, including a textual representation such as in XML.
...
* <a id="core-unicode-language-and-locale-identifiers-transmitting-locale-information-item-6"></a> **There are a**: There are a number of advantages to this strategy.

* <a id="core-unicode-language-and-locale-identifiers-transmitting-locale-information-item-7"></a> **The longer the**: The longer the data is kept in a neutral format, the more flexible the entire system is.

* <a id="core-unicode-language-and-locale-identifiers-transmitting-locale-information-item-8"></a> **On a practical**: On a practical level, if transmitted data is neutral-format, then it is much easier to manipulate the data, debug the processing of the data, and maintain the software connections between components.


* <a id="core-unicode-language-and-locale-identifiers-transmitting-locale-information-item-9"></a> **Once data has**: Once data has been localized into a given language, it can be quite difficult to programmatically convert that data into another format, if required.

* <a id="core-unicode-language-and-locale-identifiers-transmitting-locale-information-item-10"></a> **This is especially**: This is especially true if the data contains a mixture of translated text and formatted variables.

* <a id="core-unicode-language-and-locale-identifiers-transmitting-locale-information-item-11"></a> **Once information has**: Once information has been localized into, say, Romanian, it is much more difficult to localize that data into, say, French.

* <a id="core-unicode-language-and-locale-identifiers-transmitting-locale-information-item-12"></a> **Parsing is more**: Parsing is more difficult than formatting, and may run up against different ambiguities in interpreting text that has been localized, even if the original translated message text is available (which it may not be).


* <a id="core-unicode-language-and-locale-identifiers-transmitting-locale-information-item-13"></a> **Moreover, the closer**: Moreover, the closer we are to end-user, the more we know about that user's preferred formats.

* <a id="core-unicode-language-and-locale-identifiers-transmitting-locale-information-item-14"></a> **If we format**: If we format dates, for example, at the user's machine, then it can easily take into account any customizations that the user has specified.

* <a id="core-unicode-language-and-locale-identifiers-transmitting-locale-information-item-15"></a> **If the formatting**: If the formatting is done elsewhere, either we have to transmit whatever user customizations are in play, or we only transmit the user's locale code, which may only approximate the desired format.

* <a id="core-unicode-language-and-locale-identifiers-transmitting-locale-information-item-16"></a> **Thus the closer**: Thus the closer the localization is to the end user, the less we need to ship all of the user's preferences around to all the places that localization could possibly need to be done.


* <a id="core-unicode-language-and-locale-identifiers-transmitting-locale-information-item-17"></a> **Even though localization**: Even though localization should be done as close to the end-user as possible, there will be cases where different components need to be aware of whatever settings are appropriate for doing the localization.

* <a id="core-unicode-language-and-locale-identifiers-transmitting-locale-information-item-18"></a> **Thus information such**: Thus information such as a locale code or time zone needs to be communicated between different components.


#### <a name="Message_Formatting_and_Exceptions" id="core-unicode-locale-data-markup-language-ldml-unicode-language-and-locale-identifiers-transmitting-locale-information-message-formatting-and-exceptions" href="#Message_Formatting_and_Exceptions">Message Formatting and Exceptions</a>

* <a id="core-unicode-language-and-locale-identifiers-transmitting-locale-information-message-formatting-and-exceptions-item-1"></a> **Windows ([FormatMessage](https://learn.microsoft.com/en-us/windows/win32/api/winbase/nf-winbase-formatmessage), [String.Format](https://learn.microsoft.com/en-us/dotnet/api/system.string.format?view=net-6.0**: Windows ([FormatMessage](https://learn.microsoft.com/en-us/windows/win32/api/winbase/nf-winbase-formatmessage), [String.Format](https://learn.microsoft.com/en-us/dotnet/api/system.string.format?view=net-6.0)), Java ([MessageFormat](https://docs.oracle.com/javase/7/docs/api/java/text/MessageFormat.html)) and ICU ([MessageFormat](https://unicode-org.github.io/icu-docs/apidoc/released/icu4c/classMessageFormat.html), [umsg](https://unicode-org.github.io/icu-docs/apidoc/released/icu4c/umsg_8h.html)) all provide methods of formatting variables (dates, times, etc) and inserting them at arbitrary positions in a string.

* <a id="core-unicode-language-and-locale-identifiers-transmitting-locale-information-message-formatting-and-exceptions-item-2"></a> **This avoids the**: This avoids the manual string concatenation that causes severe problems for localization.

* <a id="core-unicode-language-and-locale-identifiers-transmitting-locale-information-message-formatting-and-exceptions-item-3"></a> **The question is**: The question is, where to do this?
...
* <a id="core-unicode-language-and-locale-identifiers-transmitting-locale-information-message-formatting-and-exceptions-item-5"></a> **So we will**: So we will take that case as representative of this class of issues.
...
* <a id="core-unicode-language-and-locale-identifiers-transmitting-locale-information-message-formatting-and-exceptions-item-8"></a> **This is the**: This is the best case for localization.
...
* <a id="core-unicode-language-and-locale-identifiers-transmitting-locale-information-message-formatting-and-exceptions-item-10"></a> **In such a**: In such a case, the information as to the user's locale needs to be communicated in some way to the component that is doing the localization.
...
* <a id="core-unicode-language-and-locale-identifiers-transmitting-locale-information-message-formatting-and-exceptions-item-12"></a> **This approach has**: This approach has the advantages noted above for JIT localization.


* <a id="core-unicode-language-and-locale-identifiers-transmitting-locale-information-message-formatting-and-exceptions-item-13"></a> **In addition, exceptions**: In addition, exceptions are often caught at a higher level; they do not end up being displayed to any end-user at all.

* <a id="core-unicode-language-and-locale-identifiers-transmitting-locale-information-message-formatting-and-exceptions-item-14"></a> **By avoiding the**: By avoiding the localization at the throw site, it the cost of doing formatting, when that formatting is not really necessary.
...
### <a name="Language_and_Locale_IDs" id="core-unicode-locale-data-markup-language-ldml-unicode-language-and-locale-identifiers-unicode-language-and-locale-ids" href="#Language_and_Locale_IDs">Unicode Language and Locale IDs</a>
...
* <a id="core-unicode-language-and-locale-identifiers-unicode-language-and-locale-ids-item-1"></a> **In practice, many**: In practice, many people use [[BCP47](#BCP47)] codes to mean locale codes instead of strictly language codes.

* <a id="core-unicode-language-and-locale-identifiers-unicode-language-and-locale-ids-item-2"></a> **It is easy**: It is easy to see why this came about; because [[BCP47](#BCP47)] includes an explicit region (territory) code, for most people it was sufficient for use as a locale code as well.

* <a id="core-unicode-language-and-locale-identifiers-unicode-language-and-locale-ids-item-3"></a> **For example, when**: For example, when typical web software receives a [[BCP47](#BCP47)] code, it will use it as a locale code.

* <a id="core-unicode-language-and-locale-identifiers-unicode-language-and-locale-ids-item-4"></a> **Other typical software**: Other typical software will do the same: in practice, language codes and locale codes are treated interchangeably.

* <a id="core-unicode-language-and-locale-identifiers-unicode-language-and-locale-ids-item-5"></a> **Some people recommend**: Some people recommend distinguishing on the basis of "-" versus "\_" (for example, _zh-TW_ for language code, _zh_TW_ for locale code), but in practice that does not work because of the free variation out in the world in the use of these separators.

* <a id="core-unicode-language-and-locale-identifiers-unicode-language-and-locale-ids-item-6"></a> **Notice that Windows**: Notice that Windows, for example, uses "-" as a separator in its locale codes.

* <a id="core-unicode-language-and-locale-identifiers-unicode-language-and-locale-ids-item-7"></a> **So pragmatically one**: So pragmatically one is forced to treat "-" and "\_" as equivalent when interpreting either one on input.


* <a id="core-unicode-language-and-locale-identifiers-unicode-language-and-locale-ids-item-8"></a> **Another reason for**: Another reason for the conflation of these codes is that _very_ little data in most systems is distinguished by region alone; currency codes and measurement systems being some of the few.

* <a id="core-unicode-language-and-locale-identifiers-unicode-language-and-locale-ids-item-9"></a> **Sometimes date or**: Sometimes date or number formats are mentioned as regional, but that really does not make much sense.

* <a id="core-unicode-language-and-locale-identifiers-unicode-language-and-locale-ids-item-10"></a> **If people see**: If people see the sentence "You will have to adjust the value to १,२३४.५६७ from ૭૧,૨૩૪.૫૬" (using Indic digits), they would say that sentence is simply not English.

* <a id="core-unicode-language-and-locale-identifiers-unicode-language-and-locale-ids-item-11"></a> **Number format is**: Number format is far more closely associated with language than it is with region.

* <a id="core-unicode-language-and-locale-identifiers-unicode-language-and-locale-ids-item-12"></a> **The same is**: The same is true for date formats: people would never expect to see intermixed a date in the format "2003年4月1日" (using Kanji) in text purporting to be purely English.

* <a id="core-unicode-language-and-locale-identifiers-unicode-language-and-locale-ids-item-13"></a> **There are regional**: There are regional differences in date and number format — differences which can be important — but those are different in kind than other language differences between regions.


* <a id="core-unicode-language-and-locale-identifiers-unicode-language-and-locale-ids-item-14"></a> **As far as**: As far as we are concerned — _as a completely practical matter_ — two languages are different if they require substantially different localized resources.

* <a id="core-unicode-language-and-locale-identifiers-unicode-language-and-locale-ids-item-15"></a> **Distinctions according to**: Distinctions according to spoken form are important in some contexts, but the written form is by far and away the most important issue for data interchange.

* <a id="core-unicode-language-and-locale-identifiers-unicode-language-and-locale-ids-item-16"></a> **Unfortunately, this is**: Unfortunately, this is not the principle used in [[ISO639](#ISO639)], which has the fairly unproductive notion (for data interchange) that only spoken language matters (it is also not completely consistent about this, however).


* <a id="core-unicode-language-and-locale-identifiers-unicode-language-and-locale-ids-item-17"></a> **BCP47](#BCP47)] _**can**_ express**: [[BCP47](#BCP47)] _**can**_ express a difference if the use of written languages happens to correspond to region boundaries expressed as [[ISO3166](#ISO3166)] region codes, and has recently added codes that allow it to express some important cases that are not distinguished by [[ISO3166](#ISO3166)] codes.

* <a id="core-unicode-language-and-locale-identifiers-unicode-language-and-locale-ids-item-18"></a> **These written languages**: These written languages include simplified and traditional Chinese (both used in Hong Kong S.A.R.); Serbian in Latin script; Azerbaijani in Arab script, and so on.


* <a id="core-unicode-language-and-locale-identifiers-unicode-language-and-locale-ids-item-19"></a> **Notice also that**: Notice also that _currency codes_ are different than _currency localizations_.

* <a id="core-unicode-language-and-locale-identifiers-unicode-language-and-locale-ids-item-20"></a> **The currency localizations**: The currency localizations should largely be in the language-based resource bundles, not in the territory-based resource bundles.

* <a id="core-unicode-language-and-locale-identifiers-unicode-language-and-locale-ids-item-21"></a> **Thus, the resource**: Thus, the resource bundle _en_ contains the localized mappings in English for a range of different currency codes: USD → US$, RUR → Rub, AUD → $A and so on.

* <a id="core-unicode-language-and-locale-identifiers-unicode-language-and-locale-ids-item-22"></a> **Of course, some**: Of course, some currency symbols are used for more than one currency, and in such cases specializations appear in the territory-based bundles.

* <a id="core-unicode-language-and-locale-identifiers-unicode-language-and-locale-ids-item-23"></a> **Continuing the example**: Continuing the example, _en_US_ would have USD → $, while _en_AU_ would have AUD → $. (In protocols, the currency codes should always accompany any currency amounts; otherwise the data is ambiguous, and software is forced to use the user's territory to guess at the currency.

* <a id="core-unicode-language-and-locale-identifiers-unicode-language-and-locale-ids-item-24"></a> **For some informal**: For some informal discussion of this, see [JIT Localization](https://unicode-org.github.io/icu-docs/design/jit_localization.html).)


#### <a name="Written_Language" id="core-unicode-locale-data-markup-language-ldml-unicode-language-and-locale-identifiers-unicode-language-and-locale-ids-written-language" href="#Written_Language">Written Language</a>
...
* <a id="core-unicode-language-and-locale-identifiers-unicode-language-and-locale-ids-written-language-item-1"></a> **2**: 2.

* <a id="core-unicode-language-and-locale-identifiers-unicode-language-and-locale-ids-written-language-item-2"></a> **Theater Center News**: "Theater Center News: The date of the last version of this document was 3/20/2003.

* <a id="core-unicode-language-and-locale-identifiers-unicode-language-and-locale-ids-written-language-item-3"></a> **A copy can**: A copy can be obtained for $50.00 or 1,234.57 Ukrainian hryvni.

* <a id="core-unicode-language-and-locale-identifiers-unicode-language-and-locale-ids-written-language-item-4"></a> **We would like**: We would like to acknowledge contributions by the following authors (in alphabetical order): Alaa Ghoneim, Ahmed Talaat, Asmus Freytag, Avery Bishop, Behdad Esfahbod, Doug Felt, Eric Mader."

* <a id="core-unicode-language-and-locale-identifiers-unicode-language-and-locale-ids-written-language-item-5"></a> **3**: 3.

* <a id="core-unicode-language-and-locale-identifiers-unicode-language-and-locale-ids-written-language-item-6"></a> **Theatre Centre News**: "Theatre Centre News: The date of the last version of this document was 20/3/2003.

* <a id="core-unicode-language-and-locale-identifiers-unicode-language-and-locale-ids-written-language-item-7"></a> **A copy can**: A copy can be obtained for $50.00 or 1,234.57 Ukrainian hryvni.

* <a id="core-unicode-language-and-locale-identifiers-unicode-language-and-locale-ids-written-language-item-8"></a> **We would like**: We would like to acknowledge contributions by the following authors (in alphabetical order): Alaa Ghoneim, Ahmed Talaat, Asmus Freytag, Avery Bishop, Behdad Esfahbod, Doug Felt, Eric Mader."


* <a id="core-unicode-language-and-locale-identifiers-unicode-language-and-locale-ids-written-language-item-9"></a> **Clearly there are**: Clearly there are many acceptable variations on this text.

* <a id="core-unicode-language-and-locale-identifiers-unicode-language-and-locale-ids-written-language-item-10"></a> **For example, copy**: For example, copy editors might still quibble with the use of first versus last name sorting in the list, but clearly the first list was _not_ acceptable English alphabetical order.

* <a id="core-unicode-language-and-locale-identifiers-unicode-language-and-locale-ids-written-language-item-11"></a> **And in quoting**: And in quoting a name, like "Theatre Centre News", one may leave it in the source orthography even if it differs from the publication target orthography.

* <a id="core-unicode-language-and-locale-identifiers-unicode-language-and-locale-ids-written-language-item-12"></a> **And so on**: And so on.

* <a id="core-unicode-language-and-locale-identifiers-unicode-language-and-locale-ids-written-language-item-13"></a> **However, just as**: However, just as clearly, there are limits on what is acceptable English, and "2003年3月20日", for example, is _not_.


* <a id="core-unicode-language-and-locale-identifiers-unicode-language-and-locale-ids-written-language-item-14"></a> **Note that the**: Note that the language of locale data may differ from the language of localized software or web sites, when those latter are not localized into the user's preferred language.

* <a id="core-unicode-language-and-locale-identifiers-unicode-language-and-locale-ids-written-language-item-15"></a> **In such cases**: In such cases, the kind of incongruous juxtapositions described above may well appear, but this situation is usually preferable to forcing unfamiliar date or number formats on the user as well.


#### <a name="Hybrid_Locale" id="core-unicode-locale-data-markup-language-ldml-unicode-language-and-locale-identifiers-unicode-language-and-locale-ids-hybrid-locale-identifiers" href="#Hybrid_Locale">Hybrid Locale Identifiers</a>

* <a id="core-unicode-language-and-locale-identifiers-unicode-language-and-locale-ids-hybrid-locale-identifiers-item-1"></a> **Hybrid locales have**: Hybrid locales have intermixed content from 2 (or more) languages, often with one language's grammatical structure applied to words in another.

* <a id="core-unicode-language-and-locale-identifiers-unicode-language-and-locale-ids-hybrid-locale-identifiers-item-2"></a> **These are commonly**: These are commonly referred to with portmanteau words such as _Franglais, [​Spanglish](https://en.wikipedia.org/wiki/Spanglish)_ or _Denglish_.

* <a id="core-unicode-language-and-locale-identifiers-unicode-language-and-locale-ids-hybrid-locale-identifiers-item-3"></a> **Hybrid locales do**: Hybrid locales do not _not_ reference text simply containing two languages: a book of parallel text containing English and French, such as the following, is not Franglais:
...
* <a id="core-unicode-language-and-locale-identifiers-unicode-language-and-locale-ids-hybrid-locale-identifiers-item-4"></a> **While text in**: While text in a document can be tagged as partly in one language and partly in another, that is not the same having a hybrid locale.

* <a id="core-unicode-language-and-locale-identifiers-unicode-language-and-locale-ids-hybrid-locale-identifiers-item-5"></a> **There is a**: There is a difference between having a Spanglish document, and a Spanish document that has some passages quoted in English.
...
* <a id="core-unicode-language-and-locale-identifiers-unicode-language-and-locale-ids-hybrid-locale-identifiers-item-7"></a> **More importantly, it**: More importantly, it doesn’t work for the very common use case for a [unicode_locale_id](#unicode_locale_id): _locale selection_.


* <a id="core-unicode-language-and-locale-identifiers-unicode-language-and-locale-ids-hybrid-locale-identifiers-item-8"></a> **To communicate requests**: To communicate requests for localized content and internationalization services, locales are used.

* <a id="core-unicode-language-and-locale-identifiers-unicode-language-and-locale-ids-hybrid-locale-identifiers-item-9"></a> **When people pick**: When people pick a language from a menu, internally they are picking a locale (en-GB, es-419, etc.).
...
* <a id="core-unicode-language-and-locale-identifiers-unicode-language-and-locale-ids-hybrid-locale-identifiers-item-13"></a> **\* When used**: \* When used as a request for international services (such as date formatting), the request is for everything to be in the base script if possible.
...
* <a id="core-unicode-language-and-locale-identifiers-unicode-language-and-locale-ids-hybrid-locale-identifiers-item-17"></a> **Where English is**: Where English is the scaffold, Hinglish should be represented as en-t-hi-h0-hybrid (or possibly en-Deva-t-hi-h0-hybrid)._


* <a id="core-unicode-language-and-locale-identifiers-unicode-language-and-locale-ids-hybrid-locale-identifiers-item-18"></a> **The value of**: The value of -t- is a full _[unicode_language_id](#unicode_language_id)_, and can contain a subtag for the region where it is important to include it, as in the following.
...
* <a id="core-unicode-language-and-locale-identifiers-unicode-language-and-locale-ids-hybrid-locale-identifiers-item-20"></a> **So because zh-Hant**: So because zh-Hant has different vocabulary and expressions, it could make sense to have en-t-zh-hant to make that distinction.



##### Notes <a id="core-unicode-locale-data-markup-language-ldml-unicode-language-and-locale-identifiers-unicode-language-and-locale-ids-hybrid-locale-identifiers-notes"></a>

* <a id="core-unicode-language-and-locale-identifiers-unicode-language-and-locale-ids-hybrid-locale-identifiers-note-1"></a> **Note 1**: The default script for the language is computed without reference to the hybrid subtags. Thus the default script for 'ru' is “Cyrl”, no matter what the source is in the -t- tag.
...
### <a name="Validity_Data" id="core-unicode-locale-data-markup-language-ldml-unicode-language-and-locale-identifiers-validity-data" href="#Validity_Data">Validity Data</a>
...
* <a id="core-unicode-language-and-locale-identifiers-validity-data-item-1"></a> **The directory [common/validity](https://github.com/unicode-org/cldr/blob/main/common/validity/**: The directory [common/validity](https://github.com/unicode-org/cldr/blob/main/common/validity/) contains machine-readable data for validating the language, region, script, and variant subtags, as well as currency, subdivisions and measure units.

* <a id="core-unicode-language-and-locale-identifiers-validity-data-item-2"></a> **Each file contains**: Each file contains a number of subtags with the following **idStatus** values:
...
#### Notes <a id="core-unicode-locale-data-markup-language-ldml-unicode-language-and-locale-identifiers-validity-data-notes"></a>

* <a id="core-unicode-language-and-locale-identifiers-validity-data-note-1"></a> **Note**: Note that some two-letter region codes are macroregions, and (in the future) some three-digit codes may be regular codes.
...
## <a name="Locale_Inheritance" id="core-unicode-locale-data-markup-language-ldml-locale-inheritance-and-matching" href="#Locale_Inheritance">Locale Inheritance and Matching</a>

* <a id="core-locale-inheritance-and-matching-item-1"></a> **The XML format**: The XML format relies on an inheritance model, whereby the resources are collected into _bundles_, and the bundles organized into a tree.

* <a id="core-locale-inheritance-and-matching-item-2"></a> **Data for the**: Data for the many Spanish locales does not need to be duplicated across all of the countries having Spanish as a national language.

* <a id="core-locale-inheritance-and-matching-item-3"></a> **Instead, common data**: Instead, common data is collected in the Spanish language locale, and territory locales only need to supply differences.

* <a id="core-locale-inheritance-and-matching-item-4"></a> **The parent of**: The parent of all of the language locales is a generic locale known as _root_.

* <a id="core-locale-inheritance-and-matching-item-5"></a> **Wherever possible, the**: Wherever possible, the resources in the root are language & territory neutral.

* <a id="core-locale-inheritance-and-matching-item-6"></a> **For example, the**: For example, the collation (sorting) order in the root is based on the [[DUCET](#DUCET)] (see _[Root Collation](tr35-collation.md#Root_Collation)_).

* <a id="core-locale-inheritance-and-matching-item-7"></a> **Since English language**: Since English language collation has the same ordering as the root locale, the 'en' locale data does not need to supply any collation data, nor do the 'en_US', 'en_GB' or the any of the various other locales that use English.


Given a particular locale id "en_US_someVariant", the default search chain for a particular resource is illustrated in the diagram and list below.

```mermaid
graph TD
    A["Requested: en_US_someVariant"] --> B["en_US"]
    B --> C["en"]
    C --> D["root"]
```
...
* <a id="core-locale-inheritance-and-matching-item-8"></a> **If a type**: If a type and key are supplied in the locale id, then logically the chain from that id to the root is searched for a resource tag with a given type, all the way up to root.

* <a id="core-locale-inheritance-and-matching-item-9"></a> **If no resource**: If no resource is found with that tag and type, then the chain is searched again without the type.


* <a id="core-locale-inheritance-and-matching-item-10"></a> **Thus the data**: Thus the data for any given locale will only contain resources that are different from the parent locale.

* <a id="core-locale-inheritance-and-matching-item-11"></a> **For example, most**: For example, most territory locales will inherit the bulk of their data from the language locale: "en" will contain the bulk of the data: "en_IE" will only contain a few items like currency.

* <a id="core-locale-inheritance-and-matching-item-12"></a> **All data that**: All data that is inherited from a parent is presumed to be valid, just as valid as if it were physically present in the file.

* <a id="core-locale-inheritance-and-matching-item-13"></a> **This provides for**: This provides for much smaller resource bundles, and much simpler (and less error-prone) maintenance.

* <a id="core-locale-inheritance-and-matching-item-14"></a> **At the script**: At the script or region level, the "primary" child locale will be empty, since its parent will contain all of the appropriate resources for it.

* <a id="core-locale-inheritance-and-matching-item-15"></a> **For more information**: For more information see _CLDR Information: [Default Content](tr35-info.md#Default_Content)._


* <a id="core-locale-inheritance-and-matching-item-16"></a> **Certain data items**: Certain data items depend only on the region specified in a locale id (by a [unicode_region_subtag](#unicode_region_subtag_validity) or an “rg” [Region Override](#RegionOverride) key), and are obtained from supplemental data rather than through locale resources.

* <a id="core-locale-inheritance-and-matching-item-17"></a> **For example**: For example:
...
* <a id="core-locale-inheritance-and-matching-item-19"></a> **For example, suppose**: For example, suppose data is requested for the locale id "fr_US" and there is no bundle for that combination.

* <a id="core-locale-inheritance-and-matching-item-20"></a> **Data obtained via**: Data obtained via locale inheritance, such as currency patterns and currency symbols, will be obtained from the parent locale "fr".

* <a id="core-locale-inheritance-and-matching-item-21"></a> **However, currency amounts**: However, currency amounts would be formatted by default using US dollars, just displayed in the manner governed by the locale "fr".

* <a id="core-locale-inheritance-and-matching-item-22"></a> **When a locale**: When a locale id does not specify a region, the region-specific items such as those above are obtained from the likely region for the locale (obtained via [Likely Subtags](#Likely_Subtags)).
...
### <a name="Lookup" id="core-unicode-locale-data-markup-language-ldml-locale-inheritance-and-matching-lookup" href="#Lookup">Lookup</a>
...
#### <a name="Bundle_vs_Item_Lookup" id="core-unicode-locale-data-markup-language-ldml-locale-inheritance-and-matching-lookup-bundle-vs-item-lookup" href="#Bundle_vs_Item_Lookup">Bundle vs Item Lookup</a>

There are actually two different kinds of inheritance fallback: _resource bundle lookup_ and _resource item lookup_.

```mermaid
flowchart LR
    subgraph Stage1["Stage 1: Resource Bundle Lookup"]
        A["se-FI"] --> B["se"] --> C["default-locale"] --> D["root"]
    end
    subgraph Stage2["Stage 2: Inherited Item Lookup"]
        E["Target Bundle"] --> F{"Item Exists?"}
        F -- Yes --> G["Return Value"]
        F -- No --> H["Inherit Parent Bundle Item"]
    end
```
...
* <a id="core-locale-inheritance-and-matching-lookup-bundle-vs-item-lookup-item-1"></a> **These are closely**: These are closely related, but distinct, processes.

* <a id="core-locale-inheritance-and-matching-lookup-bundle-vs-item-lookup-item-2"></a> **They are illustrated**: They are illustrated in the table [Lookup Differences](#Lookup-Differences), where "key" stands for zero or more key/type pairs.

* <a id="core-locale-inheritance-and-matching-lookup-bundle-vs-item-lookup-item-3"></a> **Logically speaking, when**: Logically speaking, when looking up an item for a given locale, you first do a resource bundle lookup to find the best bundle for the locale, then you do an inherited item lookup starting with that resource bundle.


* <a id="core-locale-inheritance-and-matching-lookup-bundle-vs-item-lookup-item-4"></a> **The table [Lookup**: The table [Lookup Differences](#Lookup-Differences) uses the naïve resource bundle lookup for illustration.

* <a id="core-locale-inheritance-and-matching-lookup-bundle-vs-item-lookup-item-5"></a> **More sophisticated systems**: More sophisticated systems will get far better results for resource bundle lookup if they use the algorithm described in _[Language Matching](#LanguageMatching)_.

* <a id="core-locale-inheritance-and-matching-lookup-bundle-vs-item-lookup-item-6"></a> **That algorithm takes**: That algorithm takes into account both the user’s desired locale(s) and the application’s supported locales, in order to get the best match.


* <a id="core-locale-inheritance-and-matching-lookup-bundle-vs-item-lookup-item-7"></a> **If the naïve**: If the naïve resource bundle lookup is used, the desired locale needs to be canonicalized using 4.3 [Likely Subtags](#Likely_Subtags) and the supplemental alias information, so that locales that CLDR considers identical are treated as such.

* <a id="core-locale-inheritance-and-matching-lookup-bundle-vs-item-lookup-item-8"></a> **Thus eng-Latn-GB should**: Thus eng-Latn-GB should be mapped to en-GB, and cmn-TW mapped to zh-Hant-TW.


* <a id="core-locale-inheritance-and-matching-lookup-bundle-vs-item-lookup-item-9"></a> **The initial bundle**: The initial bundle accessed during resource bundle lookup should not contain a script subtag unless, according to likely subtags, the script is required to disambiguate the locale.

* <a id="core-locale-inheritance-and-matching-lookup-bundle-vs-item-lookup-item-10"></a> **For example, `zh-Hant-TW**: For example, `zh-Hant-TW` should start lookup at `zh-TW` (since `zh-TW` implies `Hant`), and `de-Latn-LI` should start at `de-LI` (since `de` implies `Latn` and `de-LI` does not have its own entry in likely subtags).


* <a id="core-locale-inheritance-and-matching-lookup-bundle-vs-item-lookup-item-11"></a> **For the purposes**: For the purposes of CLDR, everything with the `<ldml>` dtd is treated logically as if it is one resource bundle, even if the implementation separates data into separate physical resource bundles.

* <a id="core-locale-inheritance-and-matching-lookup-bundle-vs-item-lookup-item-12"></a> **For example, suppose**: For example, suppose that there is a main XML file for Nama (naq), but there are no `<unit>` elements for it because the units are all inherited from root.

* <a id="core-locale-inheritance-and-matching-lookup-bundle-vs-item-lookup-item-13"></a> **If the `**: If the `<unit>` elements are separated into a separate data tree for modularity in the implementation, the Nama `<unit>` resource bundle would be empty.

* <a id="core-locale-inheritance-and-matching-lookup-bundle-vs-item-lookup-item-14"></a> **However, for purposes**: However, for purposes of resource-bundle lookup the resource bundle lookup still stops at naq.xml.
...
* <a id="core-locale-inheritance-and-matching-lookup-bundle-vs-item-lookup-table-lookup-differences-item-1"></a> **The fallback is**: The fallback is a bit different for these two cases; internal aliases and keys are not involved in the bundle lookup, and the default locale is not involved in the item lookup.

* <a id="core-locale-inheritance-and-matching-lookup-bundle-vs-item-lookup-table-lookup-differences-item-2"></a> **If the default-locale**: If the default-locale were used in the resource-item lookup, then strange results will occur.

* <a id="core-locale-inheritance-and-matching-lookup-bundle-vs-item-lookup-table-lookup-differences-item-3"></a> **For example, suppose**: For example, suppose that the default locale is Swedish, and there is a Nama locale but no specific inherited item for collation.

* <a id="core-locale-inheritance-and-matching-lookup-bundle-vs-item-lookup-table-lookup-differences-item-4"></a> **If the default-locale**: If the default-locale were used in resource-item lookup, it would produce odd and unexpected results for Nama sorting.
...
* <a id="core-locale-inheritance-and-matching-lookup-bundle-vs-item-lookup-table-lookup-differences-item-5"></a> **Resource bundle lookup**: Resource bundle lookup, on the other hand, is more flexible; changes in the view of the "best" match between the input request and the output bundle are more tolerant, when represent overall improvements for users.

* <a id="core-locale-inheritance-and-matching-lookup-bundle-vs-item-lookup-table-lookup-differences-item-6"></a> **For more information**: For more information, see _[A.1 Element fallback](#Fallback_Elements)_.
...
* <a id="core-locale-inheritance-and-matching-lookup-bundle-vs-item-lookup-table-lookup-differences-item-7"></a> **The locale data**: The locale data does not contain general character properties that are derived from the _Unicode Character Database_ [[UAX44](https://www.unicode.org/reports/tr41/#UAX44)].

* <a id="core-locale-inheritance-and-matching-lookup-bundle-vs-item-lookup-table-lookup-differences-item-8"></a> **That data being**: That data being common across locales, it is not duplicated in the bundles.

* <a id="core-locale-inheritance-and-matching-lookup-bundle-vs-item-lookup-table-lookup-differences-item-9"></a> **Constructing a POSIX**: Constructing a POSIX locale from the CLDR data requires use of UCD data.

* <a id="core-locale-inheritance-and-matching-lookup-bundle-vs-item-lookup-table-lookup-differences-item-10"></a> **In addition, POSIX**: In addition, POSIX locales may also specify the character encoding, which requires the data to be transformed into that target encoding.
...
#### <a name="Lateral_Inheritance" id="core-unicode-locale-data-markup-language-ldml-locale-inheritance-and-matching-lookup-lateral-inheritance" href="#Lateral_Inheritance">Lateral Inheritance</a>
...
###### Notes <a id="core-unicode-locale-data-markup-language-ldml-locale-inheritance-and-matching-lookup-lateral-inheritance-notes"></a>

* <a id="core-locale-inheritance-and-matching-lookup-lateral-inheritance-table-count-fallback-normal-note-1"></a> **Note**: Note that there may also be an alias in root that changes the path and starts again from the requested locale, such as:
...
#### <a name="Parent_Locales" id="core-unicode-locale-data-markup-language-ldml-locale-inheritance-and-matching-lookup-parent-locales" href="#Parent_Locales">Parent Locales</a>
...
#### <a name="Region_Priority_Inheritance" id="core-unicode-locale-data-markup-language-ldml-locale-inheritance-and-matching-lookup-region-priority-inheritance" href="#Region_Priority_Inheritance">Region-Priority Inheritance</a>

* <a id="core-locale-inheritance-and-matching-lookup-region-priority-inheritance-item-1"></a> **Certain data may**: Certain data may be more appropriate to store with the region as the primary key instead of language.

* <a id="core-locale-inheritance-and-matching-lookup-region-priority-inheritance-item-2"></a> **This is often**: This is often needed for regional user preferences, such as week info, calendar system, and measurement system.

* <a id="core-locale-inheritance-and-matching-lookup-region-priority-inheritance-item-3"></a> **All resources matched**: All resources matched by an entry in <a href="tr35-info.md#rgScope">&lt;rgScope&gt;</a> should use this type of inheritance.
...
* <a id="core-locale-inheritance-and-matching-lookup-region-priority-inheritance-item-4"></a> **2**: 2.

* <a id="core-locale-inheritance-and-matching-lookup-region-priority-inheritance-item-5"></a> **If, after performing**: If, after performing step 1, the locale is missing the region subtag (`language` or `language_script`), the region subtag should be filled in from likely subtags data.

* <a id="core-locale-inheritance-and-matching-lookup-region-priority-inheritance-item-6"></a> **For example, `en**: For example, `en` should become `en-US` before running region-priority inheritance.
...
### <a name="Inheritance_and_Validity" id="core-unicode-locale-data-markup-language-ldml-locale-inheritance-and-matching-inheritance-and-validity" href="#Inheritance_and_Validity">Inheritance and Validity</a>
...
#### <a name="Definitions" id="core-unicode-locale-data-markup-language-ldml-locale-inheritance-and-matching-inheritance-and-validity-definitions" href="#Definitions">Definitions</a>

* <a id="core-locale-inheritance-and-matching-inheritance-and-validity-definitions-item-1"></a> **Ordered_ elements are**: _Ordered_ elements are those whose sequence in the XML file is important; that is, changing the order of those elements can make a difference in the interpretation of the data.

* <a id="core-locale-inheritance-and-matching-inheritance-and-validity-definitions-item-2"></a> **These are marked**: These are marked with the `@ORDRED` annotation in the dtd file.

* <a id="core-locale-inheritance-and-matching-inheritance-and-validity-definitions-item-3"></a> **For example, consider**: For example, consider the following in `ldmlSupplemental.dtd`:
...
* <a id="core-locale-inheritance-and-matching-inheritance-and-validity-definitions-item-4"></a> **Distinguishing attributes affect**: Distinguishing attributes affect inheritance; two elements with different distinguishing attributes are treated as different for purposes of inheritance.

* <a id="core-locale-inheritance-and-matching-inheritance-and-validity-definitions-item-5"></a> **For more information**: For more information, see [Valid Attribute Values](#Valid_Attribute_Values).

* <a id="core-locale-inheritance-and-matching-inheritance-and-validity-definitions-item-6"></a> **Other attributes are**: Other attributes are called value attributes.

* <a id="core-locale-inheritance-and-matching-inheritance-and-validity-definitions-item-7"></a> **Value attributes do**: Value attributes do not affect inheritance, and elements with value attributes may not have child elements (see [XML Format](#XML_Format)).


Non-distinguishing attributes are identified by [DTD Annotations](#DTD_Annotations) such as `@VALUE`.

* <a id="core-locale-inheritance-and-matching-inheritance-and-validity-definitions-item-8"></a> **For any element**: For any element in an XML file, _an element chain_ is a resolved [[XPath](#XPath)] leading from the root to an element, with attributes on each element in alphabetical order.

* <a id="core-locale-inheritance-and-matching-inheritance-and-validity-definitions-item-9"></a> **So in, say**: So in, say, [https://github.com/unicode-org/cldr/blob/main/common/main/el.xml](https://github.com/unicode-org/cldr/blob/main/common/main/el.xml) we may have:
...
##### Notes <a id="core-unicode-locale-data-markup-language-ldml-locale-inheritance-and-matching-inheritance-and-validity-definitions-notes"></a>

* <a id="core-locale-inheritance-and-matching-inheritance-and-validity-definitions-note-1"></a> **Note 1**: There are two exceptions to this:
>
...
#### <a name="Resolved_Data_File" id="core-unicode-locale-data-markup-language-ldml-locale-inheritance-and-matching-inheritance-and-validity-resolved-data-file" href="#Resolved_Data_File">Resolved Data File</a>
...
#### <a name="Valid_Data" id="core-unicode-locale-data-markup-language-ldml-locale-inheritance-and-matching-inheritance-and-validity-valid-data" href="#Valid_Data">Valid Data</a>

* <a id="core-locale-inheritance-and-matching-inheritance-and-validity-valid-data-item-1"></a> **The attribute `draft="x**: The attribute `draft="x"` in LDML means that the data has not been approved by the subcommittee. (For more information, see [Process](https://cldr.unicode.org/index/process)).

* <a id="core-locale-inheritance-and-matching-inheritance-and-validity-valid-data-item-2"></a> **However, some data**: However, some data that is not explicitly marked as `draft` may be implicitly `draft`, either because it inherits it from a parent, or from an enclosing element.
...
* <a id="core-locale-inheritance-and-matching-inheritance-and-validity-valid-data-item-3"></a> **Any data can**: Any data can be added to that file, and the status will all be `draft="unconfirmed"`.

* <a id="core-locale-inheritance-and-matching-inheritance-and-validity-valid-data-item-4"></a> **Once an item**: Once an item is vetted—_whether it is inherited or explicitly in the file_—then its status can be changed to _approved_.

* <a id="core-locale-inheritance-and-matching-inheritance-and-validity-valid-data-item-5"></a> **This can be**: This can be done either by leaving `draft="unconfirmed"` on the enclosing element and marking the child with `draft="approved"`, such as:
...
* <a id="core-locale-inheritance-and-matching-inheritance-and-validity-valid-data-item-6"></a> **However, normally the**: However, normally the draft attributes should be canonicalized, which means they are pushed down to leaf nodes as described in _[Canonical Form](#Canonical_Form)_.

* <a id="core-locale-inheritance-and-matching-inheritance-and-validity-valid-data-item-7"></a> **If an LDML**: If an LDML file does have draft attributes that are not on leaf nodes, the file should be interpreted as if it were the canonicalized version of that file.
...
#### <a name="Checking_for_Draft_Status" id="core-unicode-locale-data-markup-language-ldml-locale-inheritance-and-matching-inheritance-and-validity-checking-for-draft-status" href="#Checking_for_Draft_Status">Checking for Draft Status</a>
...
#### <a name="Keyword_and_Default_Resolution" id="core-unicode-locale-data-markup-language-ldml-locale-inheritance-and-matching-inheritance-and-validity-keyword-and-default-resolution" href="#Keyword_and_Default_Resolution">Keyword and Default Resolution</a>
...
##### Notes <a id="core-unicode-locale-data-markup-language-ldml-locale-inheritance-and-matching-inheritance-and-validity-keyword-and-default-resolution-notes"></a>

* <a id="core-locale-inheritance-and-matching-inheritance-and-validity-keyword-and-default-resolution-note-1"></a> **Note 1**: It is an invariant that the default in root for a given element must
...
* <a id="core-locale-inheritance-and-matching-inheritance-and-validity-keyword-and-default-resolution-notes-item-1"></a> **For identifiers, such**: For identifiers, such as language codes, script codes, region codes, variant codes, types, keywords, currency symbols or currency display names, the default value is the identifier itself whenever no value is found in the root.

* <a id="core-locale-inheritance-and-matching-inheritance-and-validity-keyword-and-default-resolution-notes-item-2"></a> **Thus if there**: Thus if there is no display name for the region code 'QA' in root, then the display name is simply 'QA'.


#### <a name="Inheritance_vs_Related" id="core-unicode-locale-data-markup-language-ldml-locale-inheritance-and-matching-inheritance-and-validity-inheritance-vs-related-information" href="#Inheritance_vs_Related">Inheritance vs Related Information</a>
...
### <a name="Likely_Subtags" id="core-unicode-locale-data-markup-language-ldml-locale-inheritance-and-matching-likely-subtags" href="#Likely_Subtags">Likely Subtags</a>
...
* <a id="core-locale-inheritance-and-matching-likely-subtags-item-1"></a> **There are a**: There are a number of situations where it is useful to be able to find the most likely language, script, or region.

* <a id="core-locale-inheritance-and-matching-likely-subtags-item-2"></a> **For example, given**: For example, given the language "zh" and the region "TW", what is the most likely script?

* <a id="core-locale-inheritance-and-matching-likely-subtags-item-3"></a> **Given the script**: Given the script "Thai" what is the most likely language or region?

* <a id="core-locale-inheritance-and-matching-likely-subtags-item-4"></a> **Given the region**: Given the region TW, what is the most likely language and script?


* <a id="core-locale-inheritance-and-matching-likely-subtags-item-5"></a> **Conversely, given a**: Conversely, given a locale, it is useful to find out which fields (language, script, or region) may be superfluous, in the sense that they contain the likely tags.

* <a id="core-locale-inheritance-and-matching-likely-subtags-item-6"></a> **For example, "en_Latn**: For example, "en_Latn" can be simplified down to "en" since "Latn" is the likely script for "en"; "ja_Jpan_JP" can be simplified down to "ja".


* <a id="core-locale-inheritance-and-matching-likely-subtags-item-7"></a> **The _likelySubtag_ supplemental**: The _likelySubtag_ supplemental data provides default information for computing these values.

* <a id="core-locale-inheritance-and-matching-likely-subtags-item-8"></a> **This data is**: This data is based on the default content data, the population data, and the suppress-script data in [[BCP47](#BCP47)].

* <a id="core-locale-inheritance-and-matching-likely-subtags-item-9"></a> **It is heuristically**: It is heuristically derived, and may change over time.
...
* <a id="core-locale-inheritance-and-matching-likely-subtags-item-10"></a> **An implementation may**: An implementation may choose to exclude language tags with the language subtag "und" from the following operation.

* <a id="core-locale-inheritance-and-matching-likely-subtags-item-11"></a> **In such a**: In such a case, only the canonicalization is done.

* <a id="core-locale-inheritance-and-matching-likely-subtags-item-12"></a> **An implementation can**: An implementation can declare that it is doing the exclusion, or can take a parameter that controls whether or not to do it.
...
* <a id="core-locale-inheritance-and-matching-likely-subtags-item-13"></a> **A subtag is**: A subtag is called _empty_ if it is a missing script or region subtag, or it is a base language subtag with the value "und".

* <a id="core-locale-inheritance-and-matching-likely-subtags-item-14"></a> **In the description**: In the description below, a subscript on a subtag _x_ indicates which tag it is from: _xs_ is in the source, _xm_ is in a match, and _xr_ is in the final result.
...
### <a name="LanguageMatching" id="core-unicode-locale-data-markup-language-ldml-locale-inheritance-and-matching-language-matching" href="#LanguageMatching">Language Matching</a>
...
* <a id="core-locale-inheritance-and-matching-language-matching-item-1"></a> **For example, if**: For example, if a product supports \{ja-JP, de, zh-TW} and the user understands written American English, German, French, Swiss German, and Italian, then **de** would be the best match.

* <a id="core-locale-inheritance-and-matching-language-matching-item-2"></a> **However, if the**: However, if the user understands only Chinese (zh), then zh-TW would be the best match.


* <a id="core-locale-inheritance-and-matching-language-matching-item-3"></a> **The standard truncation-fallback**: The standard truncation-fallback algorithm does not work well when faced with the complexities of natural language.

* <a id="core-locale-inheritance-and-matching-language-matching-item-4"></a> **The language matching**: The language matching data is designed to fill that gap.

* <a id="core-locale-inheritance-and-matching-language-matching-item-5"></a> **Stated in those**: Stated in those terms, language matching can have the effect of a more complex fallback, such as:
...
* <a id="core-locale-inheritance-and-matching-language-matching-item-6"></a> **Language matching is**: Language matching is used to find the best supported locale ID given a requested list of locales.

* <a id="core-locale-inheritance-and-matching-language-matching-item-7"></a> **The requested list**: The requested list could come from different sources, such as the user's list of preferred locales in the OS Settings, or from a browser Accept-Language list.

* <a id="core-locale-inheritance-and-matching-language-matching-item-8"></a> **For example, if**: For example, if my native tongue is English, I can understand Swiss German and German, my French is rusty but usable, and Italian basic, ideally an implementation would allow me to select {gsw, de, fr} as my preferred list of locales, skipping Italian because my comprehension is not good enough for arbitrary content.


* <a id="core-locale-inheritance-and-matching-language-matching-item-9"></a> **Language Matching can**: Language Matching can also be used to get fallback data elements.

* <a id="core-locale-inheritance-and-matching-language-matching-item-10"></a> **In many cases**: In many cases, there may not be full data for a particular locale.

* <a id="core-locale-inheritance-and-matching-language-matching-item-11"></a> **For example, for**: For example, for a Breton speaker, the best fallback if data is unavailable might be French.

* <a id="core-locale-inheritance-and-matching-language-matching-item-12"></a> **That is, suppose**: That is, suppose we have found a Breton bundle, but it does not contain translation for the key "CN" (for the country China).

* <a id="core-locale-inheritance-and-matching-language-matching-item-13"></a> **It is best**: It is best to return "chine", rather than falling back to the value default locale such as Russian and getting "Китай".

* <a id="core-locale-inheritance-and-matching-language-matching-item-14"></a> **The language matching**: The language matching data can be used to get the closest fallback locales (of those supported) to a given locale.
...
* <a id="core-locale-inheritance-and-matching-language-matching-item-16"></a> **Language matching does**: Language matching does not interact with the fallback of resources _within the locale-parent chain_.

* <a id="core-locale-inheritance-and-matching-language-matching-item-17"></a> **For example, suppose**: For example, suppose that we are looking for the value for a particular path **P** in **nb-NO**.

* <a id="core-locale-inheritance-and-matching-language-matching-item-18"></a> **In the absence**: In the absence of aliases, normally the following lookup is used.


> **nb-NO** → **nb** → **root**

* <a id="core-locale-inheritance-and-matching-language-matching-item-19"></a> **That is, we**: That is, we first look in **nb-NO**.

* <a id="core-locale-inheritance-and-matching-language-matching-item-20"></a> **If there is**: If there is no value for **P** there, then we look in **nb**.

* <a id="core-locale-inheritance-and-matching-language-matching-item-21"></a> **If there is**: If there is no value for **P** there, we return the value for **P** in root (or a code value, if there is nothing there).

* <a id="core-locale-inheritance-and-matching-language-matching-item-22"></a> **Remember that if**: Remember that if there is an `alias` element along this path, then the lookup may restart with a different path in **nb-NO** (or another locale).


* <a id="core-locale-inheritance-and-matching-language-matching-item-23"></a> **However, suppose that**: However, suppose that **nb-NO** has the fallback values **[nn da sv en]**, derived from language matching.

* <a id="core-locale-inheritance-and-matching-language-matching-item-24"></a> **In that case**: In that case, an implementation _may_ progressively look up each of the listed locales, with the appropriate substitutions, returning the first value that is not found in **root**.

* <a id="core-locale-inheritance-and-matching-language-matching-item-25"></a> **This follows roughly**: This follows roughly the following pseudocode:
...
* <a id="core-locale-inheritance-and-matching-language-matching-item-26"></a> **Distances between given**: Distances between given pair of subtags can be larger or smaller than the typical distances.

* <a id="core-locale-inheritance-and-matching-language-matching-item-27"></a> **For example, the**: For example, the distance between en and en-GB can be greater than those between en-GB and en-IE.

* <a id="core-locale-inheritance-and-matching-language-matching-item-28"></a> **In some cases**: In some cases, language subtag and/or script subtag differences can be as small as the typical region difference. (Example: sr-Latn vs. sr-Cyrl).


* <a id="core-locale-inheritance-and-matching-language-matching-item-29"></a> **The distances resulting**: The distances resulting from the table are not linear, but are rather chosen to produce expected results.

* <a id="core-locale-inheritance-and-matching-language-matching-item-30"></a> **So a distance**: So a distance of 10 is not necessarily twice as "bad" as a distance of 5.

* <a id="core-locale-inheritance-and-matching-language-matching-item-31"></a> **Implementations may want**: Implementations may want to have a mode where script distances should swamp language distances.

* <a id="core-locale-inheritance-and-matching-language-matching-item-32"></a> **The tables are**: The tables are built such that this can be accomplished by increasing the language distance by 4x.
...
* <a id="core-locale-inheritance-and-matching-language-matching-item-33"></a> **This user would**: This user would expect to get "de", not "fr".

* <a id="core-locale-inheritance-and-matching-language-matching-item-34"></a> **In practice, when**: In practice, when a user selects a list of preferred locales, they don't include all the regional variants ahead of their second base locale.

* <a id="core-locale-inheritance-and-matching-language-matching-item-35"></a> **Yet while the**: Yet while the user's desired locales really doesn't tell us the priority ranking among their locales, normally the fall-off between the user's locales is substantially greater than regional variants.

* <a id="core-locale-inheritance-and-matching-language-matching-item-36"></a> **But unless F**: But unless F is greater than the distance between de-AT and de-DE, then the user’s second-choice locale would be returned.
...
* <a id="core-locale-inheritance-and-matching-language-matching-item-37"></a> **For example, suppose**: For example, suppose that nn-DE and nb-FR are being compared.

* <a id="core-locale-inheritance-and-matching-language-matching-item-38"></a> **They are first**: They are first maximized to nn-Latn-DE and nb-Latn-FR, respectively.

* <a id="core-locale-inheritance-and-matching-language-matching-item-39"></a> **The list is**: The list is searched.

* <a id="core-locale-inheritance-and-matching-language-matching-item-40"></a> **The first match**: The first match is with "\*-\*-\*", for a match of 96%.

* <a id="core-locale-inheritance-and-matching-language-matching-item-41"></a> **The locales are**: The locales are truncated to nn-Latn and nb-Latn, then to nn and nb.

* <a id="core-locale-inheritance-and-matching-language-matching-item-42"></a> **The first match**: The first match is also for a value of 96%, so the result is 92%.


* <a id="core-locale-inheritance-and-matching-language-matching-item-43"></a> **Note that language**: Note that language matching is orthogonal to the how closely two locales are related linguistically.

* <a id="core-locale-inheritance-and-matching-language-matching-item-44"></a> **For example, Breton**: For example, Breton is more closely related to Welsh than to French, but French is the better match (because it is more likely that a Breton reader will understand French than Welsh).

* <a id="core-locale-inheritance-and-matching-language-matching-item-45"></a> **This also illustrates**: This also illustrates that the matches are often asymmetric: it is not likely that a French reader will understand Breton.
...
* <a id="core-locale-inheritance-and-matching-language-matching-item-46"></a> **When the language+region**: When the language+region is not matched, and there is otherwise no reason to pick among the supported regions for that language, then some measure of geographic "closeness" can be used.

* <a id="core-locale-inheritance-and-matching-language-matching-item-47"></a> **The results may**: The results may be more understandable by users.

* <a id="core-locale-inheritance-and-matching-language-matching-item-48"></a> **Looking for en-SK**: Looking for en-SK, for example, should fall back to something within Europe (eg en-GB) in preference to something far away and unrelated (eg en-SG).

* <a id="core-locale-inheritance-and-matching-language-matching-item-49"></a> **Such a closeness**: Such a closeness metric does not need to be exact; a small amount of data can be used to give an approximate distance between any two regions.

* <a id="core-locale-inheritance-and-matching-language-matching-item-50"></a> **However, any such**: However, any such data must be used carefully; although Hong Kong is closer to India than to the UK, it is unlikely that en-IN would be a better match to en-HK than en-GB would.
...
* <a id="core-locale-inheritance-and-matching-language-matching-language-matching-variables-item-1"></a> **The syntax is**: The syntax is simple: it allows for + for _union_ and - for _set difference_, but no precedence.

* <a id="core-locale-inheritance-and-matching-language-matching-language-matching-variables-item-2"></a> **So A-B-C is**: So A-B-C is interpreted as ((A-B)-C), not as (A-(B-C)).

* <a id="core-locale-inheritance-and-matching-language-matching-language-matching-variables-item-3"></a> **For example, if**: For example, if we have A={b c}, B={a c}, C={a b}, then the result is ({b c}-{a c})-{a b} = {b}-{a b} = {}, _not_ {b c}-({a c}-{a b}) = {b c}-{c} = {b}.
...
When the set is interpreted, then macrolanguages are (logically) transformed into a list of their contents, so “053+GB” → “AU+GB+NF+NZ”. This is done recursively, so 009 → “053+054+057+061+QO” → “AU+NF+NZ+FJ+NC+PG+SB +VU...”.

##### Notes <a id="core-unicode-locale-data-markup-language-ldml-locale-inheritance-and-matching-language-matching-language-matching-variables-notes"></a>

* <a id="core-locale-inheritance-and-matching-language-matching-language-matching-variables-note-1"></a> **Note**: Note that we use 019 for all of the Americas in the variables above, because en-US should be in the same cluster as es-419 and its contents.
...
* <a id="core-locale-inheritance-and-matching-language-matching-language-matching-variables-notes-item-1"></a> **Each cluster can**: Each cluster can have one or more associated **paradigmLocales**.

* <a id="core-locale-inheritance-and-matching-language-matching-language-matching-variables-notes-item-2"></a> **These are locales**: These are locales that are preferred within a cluster.

* <a id="core-locale-inheritance-and-matching-language-matching-language-matching-variables-notes-item-3"></a> **So when matching**: So when matching desired=[en-SA] against [en-GU en en-IN en-GB], the value en-GB is returned.

* <a id="core-locale-inheritance-and-matching-language-matching-language-matching-variables-notes-item-4"></a> **Both of \{en-GU**: Both of \{en-GU en} are in a different cluster.

* <a id="core-locale-inheritance-and-matching-language-matching-language-matching-variables-notes-item-5"></a> **While \{en-IN en-GB}**: While \{en-IN en-GB} are in the same cluster, and the same distance from en-SA, the preference is given to en-GB because it is in the paradigm locales.

* <a id="core-locale-inheritance-and-matching-language-matching-language-matching-variables-notes-item-6"></a> **It would be**: It would be possible to express this in rules, but using this mechanism handles these very common cases without bulking up the tables.


* <a id="core-locale-inheritance-and-matching-language-matching-language-matching-variables-notes-item-7"></a> **The `paradigmLocales` also**: The `paradigmLocales` also allow matching to macroregions.

* <a id="core-locale-inheritance-and-matching-language-matching-language-matching-variables-notes-item-8"></a> **For example, desired=[es-419**: For example, desired=[es-419] matches to \{es-MX} more closely than to \{es}.

* <a id="core-locale-inheritance-and-matching-language-matching-language-matching-variables-notes-item-9"></a> **Vice versa: \{es-MX}**: Vice versa: \{es-MX} matches more closely to \{es-419} than to \{es}.

* <a id="core-locale-inheritance-and-matching-language-matching-language-matching-variables-notes-item-10"></a> **But_ es-MX should**: _But_ es-MX should also match more closely to es-419 than to any of the es-419 sublocales, such as \{es_CR}.

* <a id="core-locale-inheritance-and-matching-language-matching-language-matching-variables-notes-item-11"></a> **In general, in**: In general, in the absence of other distance data, there is a ‘paradigm’ in each cluster that the others match more closely to: en(-US), en-GB, es(-ES), es-419, ru(-RU)...


## <a name="XML_Format" id="core-unicode-locale-data-markup-language-ldml-xml-format" href="#XML_Format">XML Format</a>
...
* <a id="core-xml-format-item-1"></a> **The status of**: The status of the data is the same, whether or not data is split.

* <a id="core-xml-format-item-2"></a> **That is, for**: That is, for the purpose of validation and lookup, all of the data for the above ja.xml files is treated as if it was in a single file.

* <a id="core-xml-format-item-3"></a> **These files have**: These files have the `<ldml>` root element and use ldml.dtd.

* <a id="core-xml-format-item-4"></a> **The file name**: The file name must match the identity element.

* <a id="core-xml-format-item-5"></a> **For example, the**: For example, the `<ldml>` file pa_Arab_PK.xml must contain the following elements:
...
* <a id="core-xml-format-item-6"></a> **Supplemental data can**: Supplemental data can have different root elements, currently: `ldmlBCP47`, `supplementalData`, `keyboard`, and `platform`.

* <a id="core-xml-format-item-7"></a> **Keyboard and platform**: Keyboard and platform files are considered distinct.

* <a id="core-xml-format-item-8"></a> **The ldmlBCP47 files**: The ldmlBCP47 files and supplementalData files that have the same root are all logically part of the same file; they are simply split into separate files for convenience.

* <a id="core-xml-format-item-9"></a> **Implementations may split**: Implementations may split the files in different ways, also for their convenience.

* <a id="core-xml-format-item-10"></a> **The files in**: The files in /properties are also supplemental data files, but are structured like UCD properties.
...
* <a id="core-xml-format-item-11"></a> **The XML structure**: The XML structure is stable over releases.

* <a id="core-xml-format-item-12"></a> **Elements and attributes**: Elements and attributes may be deprecated: they are retained in the DTD but their usage is strongly discouraged.

* <a id="core-xml-format-item-13"></a> **In most cases**: In most cases, an alternate structure is provided for expressing the information.

* <a id="core-xml-format-item-14"></a> **There is only**: There is only one exception: newer DTDs cannot be used with version 1.1 files, without some modification.


* <a id="core-xml-format-item-15"></a> **In general, all**: In general, all translatable text in this format is in element contents, while attributes are reserved for types and non-translated information (such as numbers or dates).

* <a id="core-xml-format-item-16"></a> **The reason that**: The reason that attributes are not used for translatable text is that spaces are not preserved, and we cannot predict where spaces may be significant in translated material.
...
* <a id="core-xml-format-item-17"></a> **Rule elements do**: Rule elements do not have these restrictions, but also do not inherit, except as an entire block.

* <a id="core-xml-format-item-18"></a> **Items which are**: Items which are ordered have the DTD Annotation `@ORDERED`.

* <a id="core-xml-format-item-19"></a> **See [_DTD Annotations_](#DTD_Annotations**: See [_DTD Annotations_](#DTD_Annotations) and _[Inheritance and Validity](#Inheritance_and_Validity)_.

* <a id="core-xml-format-item-20"></a> **For more technical**: For more technical details, see [Updating-DTDs](https://cldr.unicode.org/development/updating-dtds).


* <a id="core-xml-format-item-21"></a> **Note that the**: Note that the data in examples given below is purely illustrative, and does not match any particular language.

* <a id="core-xml-format-item-22"></a> **For a more**: For a more detailed example of this format, see [[Example](#LDML)].

* <a id="core-xml-format-item-23"></a> **There is also**: There is also a DTD for this format, but _remember that the DTD alone is not sufficient to understand the semantics, the constraints, nor  the interrelationships between the different elements and attributes_.

* <a id="core-xml-format-item-24"></a> **You may wish**: You may wish to have copies of each of these to hand as you proceed through the rest of this document.


* <a id="core-xml-format-item-25"></a> **In particular, all**: In particular, all elements allow for draft versions to coexist in the file at the same time.

* <a id="core-xml-format-item-26"></a> **Thus most elements**: Thus most elements are marked in the DTD as allowing multiple instances.

* <a id="core-xml-format-item-27"></a> **However, unless an**: However, unless an element is annotated as `@ORDERED`, or has a distinguishing attribute, it can only occur once as a subelement of a given element.

* <a id="core-xml-format-item-28"></a> **Thus, for example**: Thus, for example, the following is illegal even though allowed by the DTD:
...
* <a id="core-xml-format-item-29"></a> **In general, LDML**: In general, LDML data should be in NFC format.

* <a id="core-xml-format-item-30"></a> **Normalization forms are**: Normalization forms are defined by [[UAX15](https://www.unicode.org/reports/tr41/#UAX15)].

* <a id="core-xml-format-item-31"></a> **However, certain elements**: However, certain elements may need to contain characters that are not in NFC, including exemplars, transforms, segmentations, and p/s/t/i/pc/sc/tc/ic rules in collation.

* <a id="core-xml-format-item-32"></a> **These elements must**: These elements must not be normalized (either to NFC or NFD), or their meaning may be changed.

* <a id="core-xml-format-item-33"></a> **Thus LDML documents**: Thus LDML documents must not be normalized as a whole.

* <a id="core-xml-format-item-34"></a> **To prevent problems**: To prevent problems with normalization, no element value can start with a combining slash (U+0338 COMBINING LONG SOLIDUS OVERLAY).
...
### <a name="Common_Elements" id="core-unicode-locale-data-markup-language-ldml-xml-format-common-elements" href="#Common_Elements">Common Elements</a>

At any level in any element, two special elements are allowed.

#### <a name="special" id="core-unicode-locale-data-markup-language-ldml-xml-format-common-elements-element-special" href="#special">Element special</a>

* <a id="core-xml-format-common-elements-element-special-item-1"></a> **This element is**: This element is designed to allow for arbitrary additional annotation and data that is product-specific.

* <a id="core-xml-format-common-elements-element-special-item-2"></a> **It has one**: It has one required attribute `xmlns`, which specifies the XML [namespace](https://www.w3.org/TR/REC-xml-names/) of the special data.

* <a id="core-xml-format-common-elements-element-special-item-3"></a> **For example, the**: For example, the following used the version 1.0 POSIX special element.
...
##### <a name="Sample_Special_Elements" id="core-unicode-locale-data-markup-language-ldml-xml-format-common-elements-element-special-sample-special-elements" href="#Sample_Special_Elements">Sample Special Elements</a>

* <a id="core-xml-format-common-elements-element-special-sample-special-elements-item-1"></a> **The elements in**: The elements in this section are _**not**_ part of the Locale Data Markup Language 1.0 specification.

* <a id="core-xml-format-common-elements-element-special-sample-special-elements-item-2"></a> **Instead, they are**: Instead, they are special elements used for application-specific data to be stored in the Common Locale Repository.

* <a id="core-xml-format-common-elements-element-special-sample-special-elements-item-3"></a> **They may change**: They may change or be removed in future versions of this document, and are present here more as examples of how to extend the format. (Some of these items may move into a future version of the Locale Data Markup Language specification.)
...
#### <a name="Alias_Elements" id="core-unicode-locale-data-markup-language-ldml-xml-format-common-elements-element-alias" href="#Alias_Elements">Element alias</a>
...
* <a id="core-xml-format-common-elements-element-alias-item-1"></a> **If the locale**: If the locale "de_DE" is being accessed for a month name for format/abbreviated, then a resource bundle at "de_DE" will be searched for a resource element at that path.

* <a id="core-xml-format-common-elements-element-alias-item-2"></a> **If not found**: If not found there, then the resource bundle at "de" will be searched, and so on.

* <a id="core-xml-format-common-elements-element-alias-item-3"></a> **When the alias**: When the alias is found in root, then the search is restarted, but searching for format/**wide** element instead of format/abbreviated.
...
* <a id="core-xml-format-common-elements-element-alias-table-inheritance-with-sourcelocale-item-1"></a> **The first row**: The first row shows the inheritance within the `<x>` element, whereby `<c>` is inherited from root.

* <a id="core-xml-format-common-elements-element-alias-table-inheritance-with-sourcelocale-item-2"></a> **The second shows**: The second shows the inheritance within the `<y>` element, whereby `<a>`, `<c>`, and `<d>` are inherited also from root, but from an alias there.

* <a id="core-xml-format-common-elements-element-alias-table-inheritance-with-sourcelocale-item-3"></a> **The alias in**: The alias in root is logically replaced not by the elements in root itself, but by elements in the 'target' locale.


For more details on data resolution, see [Inheritance and Validity](#Inheritance_and_Validity).

* <a id="core-xml-format-common-elements-element-alias-table-inheritance-with-sourcelocale-item-4"></a> **Aliases must be**: Aliases must be resolved recursively.

* <a id="core-xml-format-common-elements-element-alias-table-inheritance-with-sourcelocale-item-5"></a> **An alias may**: An alias may point to another path that results in another alias being found, and so on.

* <a id="core-xml-format-common-elements-element-alias-table-inheritance-with-sourcelocale-item-6"></a> **For example, looking**: For example, looking up Thai buddhist abbreviated months for the locale **xx-YY** may result in the following chain of aliases being followed:
...
* <a id="core-xml-format-common-elements-element-alias-table-inheritance-with-sourcelocale-item-7"></a> **It is an**: It is an error to have a circular chain of aliases.

* <a id="core-xml-format-common-elements-element-alias-table-inheritance-with-sourcelocale-item-8"></a> **That is, a**: That is, a collection of LDML XML documents must not have situations where a sequence of alias lookups (including inheritance and lateral inheritance) can be followed indefinitely without terminating.


#### <a name="Element_displayName" id="core-unicode-locale-data-markup-language-ldml-xml-format-common-elements-element-displayname" href="#Element_displayName">Element displayName</a>

* <a id="core-xml-format-common-elements-element-displayname-item-1"></a> **Many elements can**: Many elements can have a display name.

* <a id="core-xml-format-common-elements-element-displayname-item-2"></a> **This is a**: This is a translated name that can be presented to users when discussing the particular service.

* <a id="core-xml-format-common-elements-element-displayname-item-3"></a> **For example, a**: For example, a number format, used to format numbers using the conventions of that locale, can have translated name for presentation in GUIs.
...
### <a name="Common_Attributes" id="core-unicode-locale-data-markup-language-ldml-xml-format-common-attributes" href="#Common_Attributes">Common Attributes</a>

#### <a name="Attribute_type" id="core-unicode-locale-data-markup-language-ldml-xml-format-common-attributes-attribute-type" href="#Attribute_type">Attribute type</a>
...
#### <a name="Attribute_draft" id="core-unicode-locale-data-markup-language-ldml-xml-format-common-attributes-attribute-draft" href="#Attribute_draft">Attribute draft</a>
...
#### <a name="alt_attribute" id="core-unicode-locale-data-markup-language-ldml-xml-format-common-attributes-attribute-alt" href="#alt_attribute">Attribute alt</a>
...
* <a id="core-xml-format-common-attributes-attribute-alt-item-1"></a> **proposed` should only**: `proposed` should only be present if the draft status is not `approved`.

* <a id="core-xml-format-common-attributes-attribute-alt-item-2"></a> **It indicates that**: It indicates that the data is proposed replacement data that has been added provisionally until the differences between it and the other data can be vetted.

* <a id="core-xml-format-common-attributes-attribute-alt-item-3"></a> **For example, suppose**: For example, suppose that the translation for September for some language is "Settembru", and a bug report is filed that that should be "Settembro".

* <a id="core-xml-format-common-attributes-attribute-alt-item-4"></a> **The new data**: The new data can be entered in, but marked as `alt="proposed"` until it is vetted.
...
#### <a name="references_attribute" id="core-unicode-locale-data-markup-language-ldml-xml-format-common-attributes-attribute-references" href="#references_attribute">Attribute references</a>

* <a id="core-xml-format-common-attributes-attribute-references-item-1"></a> **The value of**: The value of this attribute is a token representing a reference for the information in the element, including standards that it may conform to.

* <a id="core-xml-format-common-attributes-attribute-references-item-2"></a> **`. (In older**: `<references>`. (In older versions of CLDR, the value of the attribute was freeform text.

* <a id="core-xml-format-common-attributes-attribute-references-item-3"></a> **That format is**: That format is deprecated.)
...
* <a id="core-xml-format-common-attributes-attribute-references-item-4"></a> **This attribute was**: This attribute was originally intended for use in marking display names whose capitalization differed from what was indicated by the now-deprecated `<inText>` element (perhaps, for example, because the names included a proper noun).

* <a id="core-xml-format-common-attributes-attribute-references-item-5"></a> **It was never**: It was never supported in the dtd and is not needed for use with the new `<contextTransforms>` element.


### <a name="Common_Structures" id="core-unicode-locale-data-markup-language-ldml-xml-format-common-structures" href="#Common_Structures">Common Structures</a>

#### <a name="Date_Ranges" id="core-unicode-locale-data-markup-language-ldml-xml-format-common-structures-date-and-date-ranges" href="#Date_Ranges">Date and Date Ranges</a>

* <a id="core-xml-format-common-structures-date-and-date-ranges-item-1"></a> **When attribute specify**: When attribute specify date ranges, it is usually done with attributes `from` and `to`.

* <a id="core-xml-format-common-structures-date-and-date-ranges-item-2"></a> **The `from` attribute**: The `from` attribute specifies the starting point, and the `to` attribute specifies the end point.

* <a id="core-xml-format-common-structures-date-and-date-ranges-item-3"></a> **The deprecated `time**: The deprecated `time` attribute was formerly used to specify time with the deprecated `weekEndStart` and `weekEndEnd` elements, which were themselves inherently `from` or `to`.


* <a id="core-xml-format-common-structures-date-and-date-ranges-item-4"></a> **The data format**: The data format is a restricted ISO 8601 format, restricted to the fields `year`, `month`, `day`, `hour`, `minute`, and `second` in that order, with "-" used as a separator between date fields, a space used as the separator between the date and the time fields, and `:` used as a separator between the time fields.

* <a id="core-xml-format-common-structures-date-and-date-ranges-item-5"></a> **If the `minute**: If the `minute` or `minute` and `second` are absent, they are interpreted as zero.

* <a id="core-xml-format-common-structures-date-and-date-ranges-item-6"></a> **If the `hour**: If the `hour` is also missing, then it is interpreted based on whether the attribute is `from` or `to`.
...
#### <a name="Text_Directionality" id="core-unicode-locale-data-markup-language-ldml-xml-format-common-structures-text-directionality" href="#Text_Directionality">Text Directionality</a>

* <a id="core-xml-format-common-structures-text-directionality-item-1"></a> **The content of**: The content of certain elements, such as date or number formats, may consist of several sub-elements with an inherent order (for example, the year, month, and day for dates).

* <a id="core-xml-format-common-structures-text-directionality-item-2"></a> **In some cases**: In some cases, the order of these sub-elements may be changed depending on the bidirectional context in which the element is embedded.
...
#### <a name="Unicode_Sets" id="core-unicode-locale-data-markup-language-ldml-xml-format-common-structures-unicode-sets" href="#Unicode_Sets">Unicode Sets</a>
...
##### <a name="Lists_of_Code_Points" id="core-unicode-locale-data-markup-language-ldml-xml-format-common-structures-unicode-sets-lists-of-code-points" href="#Lists_of_Code_Points">Lists of Code Points</a>

* <a id="core-xml-format-common-structures-unicode-sets-lists-of-code-points-item-1"></a> **Lists are a**: Lists are a sequence of strings that may include ranges, which are indicated by a '-' between two code points, as in "a-z".

* <a id="core-xml-format-common-structures-unicode-sets-lists-of-code-points-item-2"></a> **The sequence _start-end**: The sequence _start-end_ specifies the range of all code points from the start to end, inclusive, in Unicode order.

* <a id="core-xml-format-common-structures-unicode-sets-lists-of-code-points-item-3"></a> **For example, **[a**: For example, **[a c d-f m]** is equivalent to **[a c d e f m]**.

* <a id="core-xml-format-common-structures-unicode-sets-lists-of-code-points-item-4"></a> **Whitespace can be**: Whitespace can be freely used for clarity, as **[a c d-f m]** means the same as **[acd-fm]**.


* <a id="core-xml-format-common-structures-unicode-sets-lists-of-code-points-item-5"></a> **A string with**: A string with multiple code points is represented in a list by being surrounded by curly braces, such as in **[a-z \{ch}]**.

* <a id="core-xml-format-common-structures-unicode-sets-lists-of-code-points-item-6"></a> **It can be**: It can be used with the range notation, with the restriction that each string contains exactly one code point.

* <a id="core-xml-format-common-structures-unicode-sets-lists-of-code-points-item-7"></a> **Thus **\[\{ab\}-\{c\}\]**, **\[\{ax\}-\{bz\}\]****: Thus **\[\{ab\}-\{c\}\]**, **\[\{ax\}-\{bz\}\]**, and **\[\{ab\}-c\]** are invalid.

* <a id="core-xml-format-common-structures-unicode-sets-lists-of-code-points-item-8"></a> **A string consisting**: A string consisting of a single code point is equivalent to that code point, that is, **[\{a}-c]** is valid and equivalent to **[a b c]**.


##### <a name="Backslash_Escapes" id="core-unicode-locale-data-markup-language-ldml-xml-format-common-structures-unicode-sets-backslash-escapes" href="#Backslash_Escapes">Backslash Escapes</a>
...
* <a id="core-xml-format-common-structures-unicode-sets-backslash-escapes-item-1"></a> **Any code point**: Any code point formed as the result of a backslash escape loses any special meaning and is treated as a literal.

* <a id="core-xml-format-common-structures-unicode-sets-backslash-escapes-item-2"></a> **In particular, note**: In particular, note that \\x, \\u and \\U escapes create literal code points. (In contrast, Java treats Unicode escapes as just a way to represent arbitrary code points in an ASCII source file, and any resulting code points are _**not**_ tagged as literals.)


* <a id="core-xml-format-common-structures-unicode-sets-backslash-escapes-item-3"></a> **Unicode property sets**: Unicode property sets are defined as described in _UTS #18: Unicode Regular Expressions_ [[UTS18](https://www.unicode.org/reports/tr41/#UTS18)], Level 1 and RL2.5, including the syntax where given.

* <a id="core-xml-format-common-structures-unicode-sets-backslash-escapes-item-4"></a> **For an example**: For an example of a concrete implementation of this, see [[ICUUnicodeSet](#ICUUnicodeSet)].


##### <a name="Unicode_Properties" id="core-unicode-locale-data-markup-language-ldml-xml-format-common-structures-unicode-sets-unicode-properties" href="#Unicode_Properties">Unicode Properties</a>

* <a id="core-xml-format-common-structures-unicode-sets-unicode-properties-item-1"></a> **Briefly, Unicode property**: Briefly, Unicode property sets are specified by any Unicode property and a value of that property, such as **[:General_Category=Letter:]** for Unicode letters or **\\p\{uppercase}** for the set of upper case letters in Unicode.

* <a id="core-xml-format-common-structures-unicode-sets-unicode-properties-item-2"></a> **The property names**: The property names are defined by the PropertyAliases.txt file and the property values by the PropertyValueAliases.txt file.

* <a id="core-xml-format-common-structures-unicode-sets-unicode-properties-item-3"></a> **For more information**: For more information, see [[UAX44](https://www.unicode.org/reports/tr41/#UAX44)].

* <a id="core-xml-format-common-structures-unicode-sets-unicode-properties-item-4"></a> **The syntax for**: The syntax for specifying the property sets is an extension of either POSIX or Perl syntax, by the addition of `"=<value>"`.

* <a id="core-xml-format-common-structures-unicode-sets-unicode-properties-item-5"></a> **For example, you**: For example, you can match letters by using the POSIX-style syntax:
...
* <a id="core-xml-format-common-structures-unicode-sets-unicode-properties-item-6"></a> **Property names and**: Property names and values are case-insensitive, and whitespace, "-", and "\_" are ignored.

* <a id="core-xml-format-common-structures-unicode-sets-unicode-properties-item-7"></a> **The property name**: The property name can be omitted for the **General_Category** and **Script** properties, but is required for other properties.

* <a id="core-xml-format-common-structures-unicode-sets-unicode-properties-item-8"></a> **If the property**: If the property value is omitted, it is assumed to represent a boolean property with the value "true".

* <a id="core-xml-format-common-structures-unicode-sets-unicode-properties-item-9"></a> **Thus **[:Letter:]** is**: Thus **[:Letter:]** is equivalent to **[:General_Category=Letter:]**, and **[:Wh-ite-s pa_ce:]** is equivalent to **[:Whitespace=true:]**.


* <a id="core-xml-format-common-structures-unicode-sets-unicode-properties-item-10"></a> **The table below**: The table below shows the two kinds of syntax: POSIX and Perl style.

* <a id="core-xml-format-common-structures-unicode-sets-unicode-properties-item-11"></a> **Also, the table**: Also, the table shows the "Negative" version, which is a property that excludes all code points of a given kind.

* <a id="core-xml-format-common-structures-unicode-sets-unicode-properties-item-12"></a> **For example, **[:^Letter:]****: For example, **[:^Letter:]** matches all code points that are not **[:Letter:]**.
...
##### <a name="Boolean_Operations" id="core-unicode-locale-data-markup-language-ldml-xml-format-common-structures-unicode-sets-boolean-operations" href="#Boolean_Operations">Boolean Operations</a>
...
* <a id="core-xml-format-common-structures-unicode-sets-boolean-operations-item-1"></a> **The binary operators**: The binary operators '&', '-', and the implicit union have equal precedence and bind left-to-right.

* <a id="core-xml-format-common-structures-unicode-sets-boolean-operations-item-2"></a> **Thus **[[:letter:]-[a-z]-[\\u0100-\\u01FF]]** is**: Thus **[[:letter:]-[a-z]-[\\u0100-\\u01FF]]** is equal to **[[[:letter:]-[a-z]]-[\\u0100-\\u01FF]]**.

* <a id="core-xml-format-common-structures-unicode-sets-boolean-operations-item-3"></a> **Another example is**: Another example is the set **[[ace][bdf] - [abc][def]]**, which is not the empty set, but instead equal to **[[[[ace] [bdf]] - [abc]] [def]]**, which equals **[[[abcdef] - [abc]] [def]]**, which equals **[[def] [def]]**, which equals **[def]**.
...
##### <a name="Variables_in_UnicodeSets" id="core-unicode-locale-data-markup-language-ldml-xml-format-common-structures-unicode-sets-variables-in-unicodesets" href="#Variables_in_UnicodeSets">Variables in UnicodeSets</a>
...
* <a id="core-xml-format-common-structures-unicode-sets-variables-in-unicodesets-item-1"></a> **UnicodeSets may contain**: UnicodeSets may contain variables (`$my_char`, `$the_set`, ...) in place of full UnicodeSets and strings/characters.

* <a id="core-xml-format-common-structures-unicode-sets-variables-in-unicodesets-item-2"></a> **If variable support**: If variable support is enabled, variables must be defined (out-of-scope for UnicodeSets).

* <a id="core-xml-format-common-structures-unicode-sets-variables-in-unicodesets-item-3"></a> **In particular, referring**: In particular, referring to undefined variables is an error.
...
###### Notes <a id="core-unicode-locale-data-markup-language-ldml-xml-format-common-structures-unicode-sets-variables-in-unicodesets-notes"></a>

* <a id="core-xml-format-common-structures-unicode-sets-variables-in-unicodesets-note-1"></a> **Note 1**: In particular, the variable map is needed not just to compute the actual set of characters and strings represented by the UnicodeSet,
...
##### <a name="UnicodeSet_Examples" id="core-unicode-locale-data-markup-language-ldml-xml-format-common-structures-unicode-sets-unicodeset-examples" href="#UnicodeSet_Examples">UnicodeSet Examples</a>
...
#### <a name="String_Range" id="core-unicode-locale-data-markup-language-ldml-xml-format-common-structures-string-range" href="#String_Range">String Range</a>
...
##### Notes <a id="core-unicode-locale-data-markup-language-ldml-xml-format-common-structures-string-range-notes"></a>

* <a id="core-xml-format-common-structures-string-range-note-1"></a> **Note**: Note that P will be an empty string if the lengths of X and Y are equal.
...
### <a name="Identity_Elements" id="core-unicode-locale-data-markup-language-ldml-xml-format-identity-elements" href="#Identity_Elements">Identity Elements</a>
...
* <a id="core-xml-format-identity-elements-item-1"></a> **When combined according**: When combined according to the rules described in _[Unicode Language and Locale Identifiers](#Unicode_Language_and_Locale_Identifiers)_, the `language` element, along with any of the optional `script`, `territory`, and `variant` elements, must identify a known, stable locale identifier.

* <a id="core-xml-format-identity-elements-item-2"></a> **Otherwise, it is**: Otherwise, it is an error.


### <a name="Valid_Attribute_Values" id="core-unicode-locale-data-markup-language-ldml-xml-format-valid-attribute-values" href="#Valid_Attribute_Values">Valid Attribute Values</a>
...
### <a name="Canonical_Form" id="core-unicode-locale-data-markup-language-ldml-xml-format-canonical-form" href="#Canonical_Form">Canonical Form</a>
...
* <a id="core-xml-format-canonical-form-item-1"></a> **XML](https://www.w3.org/TR/REC-xml/) files can**: [XML](https://www.w3.org/TR/REC-xml/) files can have a wide variation in textual form, while representing precisely the same data.

* <a id="core-xml-format-canonical-form-item-2"></a> **By putting the**: By putting the LDML files in the repository into a canonical form, this allows us to use the simple diff tools used widely (and in CVS) to detect differences when vetting changes, without those tools being confused.

* <a id="core-xml-format-canonical-form-item-3"></a> **This is not**: This is not a requirement on other uses of LDML; just simply a way to manage repository data more easily.


#### <a name="Content" id="core-unicode-locale-data-markup-language-ldml-xml-format-canonical-form-content" href="#Content">Content</a>
...
* <a id="core-xml-format-canonical-form-content-item-1"></a> **That is, new**: That is, new IDs are added, but existing ones keep the original form.

* <a id="core-xml-format-canonical-form-content-item-2"></a> **The _TZ_ timezone**: The _TZ_ timezone database keeps a set of equivalences in the "backward" file.

* <a id="core-xml-format-canonical-form-content-item-3"></a> **These are used**: These are used to map other tzids to the canonical form.

* <a id="core-xml-format-canonical-form-content-item-4"></a> **For example, when**: For example, when `America/Argentina/Catamarca` was introduced as the new name for the previous `America/Catamarca` , a link was added in the backward file.
...
#### <a name="Ordering" id="core-unicode-locale-data-markup-language-ldml-xml-format-canonical-form-ordering" href="#Ordering">Ordering</a>

* <a id="core-xml-format-canonical-form-ordering-item-1"></a> **An element is**: An element is ordered first by the element name, and then if the element names are identical, by the sorted set of attribute-value pairs.

* <a id="core-xml-format-canonical-form-ordering-item-2"></a> **For the latter**: For the latter, compare the first pair in each (in sorted order by attribute pair).

* <a id="core-xml-format-canonical-form-ordering-item-3"></a> **If not identical**: If not identical, go to the second pair, and so on.
...
#### <a name="Comments" id="core-unicode-locale-data-markup-language-ldml-xml-format-canonical-form-comments" href="#Comments">Comments</a>
...
### <a name="DTD_Annotations" id="core-unicode-locale-data-markup-language-ldml-xml-format-dtd-annotations" href="#DTD_Annotations">DTD Annotations</a>
...
## <a name="Property_Data" id="core-unicode-locale-data-markup-language-ldml-property-data" href="#Property_Data">Property Data</a>

* <a id="core-property-data-item-1"></a> **Some data in**: Some data in CLDR does not use an XML format, but rather a semicolon-delimited format derived from that of the Unicode Character Database.

* <a id="core-property-data-item-2"></a> **That is because**: That is because the data is more likely to be parsed by implementations that already parse UCD data.

* <a id="core-property-data-item-3"></a> **Those files are**: Those files are present in the common/properties directory.


Each file has a header that explains the format and usage of the data.

### <a name="Script_Metadata" id="core-unicode-locale-data-markup-language-ldml-property-data-script-metadata" href="#Script_Metadata">Script Metadata</a>

`scriptMetadata.txt`

* <a id="core-property-data-script-metadata-item-1"></a> **This file provides**: This file provides general information about scripts that may be useful to implementations processing text.

* <a id="core-property-data-script-metadata-item-2"></a> **The information is**: The information is the best currently available, and may change between versions of CLDR.

* <a id="core-property-data-script-metadata-item-3"></a> **The format is**: The format is similar to Unicode Character Database property file, and is documented in the header of the data file.


### <a name="Extended_Pictographic" id="core-unicode-locale-data-markup-language-ldml-property-data-extended-pictographic" href="#Extended_Pictographic">Extended Pictographic</a>

`ExtendedPictographic.txt`

* <a id="core-property-data-extended-pictographic-item-1"></a> **This file was**: This file was used to define the ExtendedPictographic data used for “future-proofing” emoji behavior, especially in segmentation.

* <a id="core-property-data-extended-pictographic-item-2"></a> **As of Emoji**: As of Emoji version 11.0, the set of Extended_Pictographic is incorporated into the emoji data files found at [unicode.org/Public/emoji/](https://www.unicode.org/Public/emoji/).


### <a name="Labels.txt" id="core-unicode-locale-data-markup-language-ldml-property-data-labelstxt" href="#Labels.txt">Labels.txt</a>

`labels.txt`

* <a id="core-property-data-labelstxt-item-1"></a> **This file provides**: This file provides general information about associations of labels to characters that may be useful to implementations of character-picking applications.

* <a id="core-property-data-labelstxt-item-2"></a> **The information is**: The information is the best currently available, and may change between versions of CLDR.

* <a id="core-property-data-labelstxt-item-3"></a> **The format is**: The format is similar to Unicode Character Database property file, and is documented in the header of the data file.


Initially, the contents are focused on emoji, but may be expanded in the future to other types of characters.

#### Notes <a id="core-unicode-locale-data-markup-language-ldml-property-data-labelstxt-notes"></a>

* <a id="core-property-data-labelstxt-note-1"></a> **Note**: Note that a character may have multiple labels.

### <a name="Segmentation_Tests" id="core-unicode-locale-data-markup-language-ldml-property-data-segmentation-tests" href="#Segmentation_Tests">Segmentation Tests</a>

* <a id="core-property-data-segmentation-tests-item-1"></a> **CLDR provides a**: CLDR provides a tailoring to the [Grapheme Cluster Break (gcb)](https://www.unicode.org/reports/tr29/) algorithm to avoid splitting Indic aksaras.

* <a id="core-property-data-segmentation-tests-item-2"></a> **The corresponding test**: The corresponding test files for that are located in common/properties/segments/, along with a readme.txt that provides more details.

* <a id="core-property-data-segmentation-tests-item-3"></a> **There are also**: There are also specific test files for the supported Indic scripts in the unittest directory.




## <a name="Format_Parse_Issues" id="core-unicode-locale-data-markup-language-ldml-issues-in-formatting-and-parsing" href="#Format_Parse_Issues">Issues in Formatting and Parsing</a>

### <a name="Lenient_Parsing" id="core-unicode-locale-data-markup-language-ldml-issues-in-formatting-and-parsing-lenient-parsing" href="#Lenient_Parsing">Lenient Parsing</a>

#### <a name="Motivation" id="core-unicode-locale-data-markup-language-ldml-issues-in-formatting-and-parsing-lenient-parsing-motivation" href="#Motivation">Motivation</a>

* <a id="core-issues-in-formatting-and-parsing-lenient-parsing-motivation-item-1"></a> **User input is**: User input is frequently messy.

* <a id="core-issues-in-formatting-and-parsing-lenient-parsing-motivation-item-2"></a> **Attempting to parse**: Attempting to parse it by matching it exactly against a pattern is likely to be unsuccessful, even when the meaning of the input is clear to a human being.

* <a id="core-issues-in-formatting-and-parsing-lenient-parsing-motivation-item-3"></a> **For example, for**: For example, for a date pattern of "MM/dd/yy", the input "June 1, 2006" will fail.


* <a id="core-issues-in-formatting-and-parsing-lenient-parsing-motivation-item-4"></a> **The goal of**: The goal of lenient parsing is to accept user input whenever it is possible to decipher what the user intended.

* <a id="core-issues-in-formatting-and-parsing-lenient-parsing-motivation-item-5"></a> **Doing so requires**: Doing so requires using patterns as data to guide the parsing process, rather than an exact template that must be matched.

* <a id="core-issues-in-formatting-and-parsing-lenient-parsing-motivation-item-6"></a> **This informative section**: This informative section suggests some heuristics that may be useful for lenient parsing of dates, times, and numbers.


#### <a name="Loose_Matching" id="core-unicode-locale-data-markup-language-ldml-issues-in-formatting-and-parsing-lenient-parsing-loose-matching" href="#Loose_Matching">Loose Matching</a>
...
* <a id="core-issues-in-formatting-and-parsing-lenient-parsing-loose-matching-item-1"></a> **Loose matching involves**: Loose matching involves (logically) applying the above transform to both the input text and to each of the field elements used in matching, before applying the specific heuristics below.

* <a id="core-issues-in-formatting-and-parsing-lenient-parsing-loose-matching-item-2"></a> **For example, if**: For example, if the input number text is " - NA f.

* <a id="core-issues-in-formatting-and-parsing-lenient-parsing-loose-matching-item-3"></a> **1,000.00", then it**: 1,000.00", then it is mapped to "-naf1,000.00" before processing.

* <a id="core-issues-in-formatting-and-parsing-lenient-parsing-loose-matching-item-4"></a> **The currency signs**: The currency signs are also transformed, so "NA f." is converted to "naf" for purposes of matching.

* <a id="core-issues-in-formatting-and-parsing-lenient-parsing-loose-matching-item-5"></a> **As with other**: As with other Unicode algorithms, this is a logical statement of the process; actual implementations can optimize, such as by applying the transform incrementally during matching.


### <a name="Invalid_Patterns" id="core-unicode-locale-data-markup-language-ldml-issues-in-formatting-and-parsing-handling-invalid-patterns" href="#Invalid_Patterns">Handling Invalid Patterns</a>

* <a id="core-issues-in-formatting-and-parsing-handling-invalid-patterns-item-1"></a> **Processes sometimes encounter**: Processes sometimes encounter invalid number or date patterns, such as a number pattern with “¤¤¤¤¤” (valid pattern character but invalid length in current CLDR), a date pattern with “nn” (invalid pattern character in current CLDR), or a date pattern with “MMMMMM” (invalid length in current CLDR).

* <a id="core-issues-in-formatting-and-parsing-handling-invalid-patterns-item-2"></a> **The recommended behavior**: The recommended behavior for handling such an invalid pattern field is:
...
## <a name="Data_Size" id="core-unicode-locale-data-markup-language-ldml-data-size-reduction" href="#Data_Size">Data Size Reduction</a>
...
### <a name="Vertical_Slicing" id="core-unicode-locale-data-markup-language-ldml-data-size-reduction-vertical-slicing" href="#Vertical_Slicing">Vertical Slicing</a>
...
### <a name="Horizontal_Slicing" id="core-unicode-locale-data-markup-language-ldml-data-size-reduction-horizontal-slicing" href="#Horizontal_Slicing">Horizontal Slicing</a>
...
## <a name="Deprecated_Structure" id="core-unicode-locale-data-markup-language-ldml-annex-a-deprecated-structure" href="#Deprecated_Structure">Annex A Deprecated Structure</a>
...
### <a name="Fallback_Elements" id="core-unicode-locale-data-markup-language-ldml-annex-a-deprecated-structure-a1-element-fallback" href="#Fallback_Elements">A.1 Element fallback</a>

Implementations should use instead the information in [Language Matching](#LanguageMatching) for doing language fallback.

### <a name="BCP47_Keyword_Mapping" id="core-unicode-locale-data-markup-language-ldml-annex-a-deprecated-structure-a2-bcp-47-keyword-mapping" href="#BCP47_Keyword_Mapping">A.2 BCP 47 Keyword Mapping</a>

Instead use the mechanisms descibed in [U Extension Data Files](#Unicode_Locale_Extension_Data_Files).

### <a name="Choice_Patterns" id="core-unicode-locale-data-markup-language-ldml-annex-a-deprecated-structure-a3-choice-patterns" href="#Choice_Patterns">A.3 Choice Patterns</a>

Instead use `count` attributes.

### <a name="Element_default" id="core-unicode-locale-data-markup-language-ldml-annex-a-deprecated-structure-a4-element-default" href="#Element_default">A.4 Element default</a>
...
### <a name="Deprecated_Common_Attributes" id="core-unicode-locale-data-markup-language-ldml-annex-a-deprecated-structure-a5-deprecated-common-attributes" href="#Deprecated_Common_Attributes">A.5 Deprecated Common Attributes</a>

#### <a name="Attribute_standard" id="core-unicode-locale-data-markup-language-ldml-annex-a-deprecated-structure-a5-deprecated-common-attributes-a51-attribute-standard" href="#Attribute_standard">A.5.1 Attribute standard</a>

Instead, use a `reference` element with the attribute `standard="true"`.

#### <a name="Attribute_draft_nonLeaf" id="core-unicode-locale-data-markup-language-ldml-annex-a-deprecated-structure-a5-deprecated-common-attributes-a52-attribute-draft-in-non-leaf-elements" href="#Attribute_draft_nonLeaf">A.5.2 Attribute draft in non-leaf elements</a>

The `draft` attribute is deprecated except in leaf elements (elements that do not have any subelements)

### <a name="Element_base" id="core-unicode-locale-data-markup-language-ldml-annex-a-deprecated-structure-a6-element-base" href="#Element_base">A.6 Element base</a>

Instead use the collation `<import>` element.

### <a name="Element_rules" id="core-unicode-locale-data-markup-language-ldml-annex-a-deprecated-structure-a7-element-rules" href="#Element_rules">A.7 Element rules</a>

Instead use the basic collation syntax with the [`<cr>` element](tr35-collation.md#Rules).

### <a name="Deprecated_subelements_of_dates" id="core-unicode-locale-data-markup-language-ldml-annex-a-deprecated-structure-a8-deprecated-subelements-of" href="#Deprecated_subelements_of_dates">A.8 Deprecated subelements of `<dates>`</a>

* `<localizedPatternChars>`
* `<dateRangePattern>`, replaced by `<intervalFormats>`.

### <a name="Deprecated_subelements_of_calendars" id="core-unicode-locale-data-markup-language-ldml-annex-a-deprecated-structure-a9-deprecated-subelements-of" href="#Deprecated_subelements_of_calendars">A.9 Deprecated subelements of `<calendars>`</a>
...
### <a name="Deprecated_subelements_of_timeZoneNames" id="core-unicode-locale-data-markup-language-ldml-annex-a-deprecated-structure-a10-deprecated-subelements-of" href="#Deprecated_subelements_of_timeZoneNames">A.10 Deprecated subelements of `<timeZoneNames>`</a>
...
### <a name="Deprecated_subelements_of_zone_metazone" id="core-unicode-locale-data-markup-language-ldml-annex-a-deprecated-structure-a11-deprecated-subelements-of-and" href="#Deprecated_subelements_of_zone_metazone">A.11 Deprecated subelements of `<zone>` and `<metazone>`</a>

* `<commonlyUsed>`, formerly used to indicate whether a zone was commonly used in the locale.

### <a name="Renamed_attribute_values_for_contextTransformUsage" id="core-unicode-locale-data-markup-language-ldml-annex-a-deprecated-structure-a12-renamed-attribute-values-for-element" href="#Renamed_attribute_values_for_contextTransformUsage">A.12 Renamed attribute values for `<contextTransformUsage>` element</a>

* <a id="core-annex-a-deprecated-structure-a12-renamed-attribute-values-for-element-item-1"></a> **The `` element**: The `<contextTransformUsage>` element was introduced in CLDR 21.

* <a id="core-annex-a-deprecated-structure-a12-renamed-attribute-values-for-element-item-2"></a> **The values for**: The values for its `type` attribute are documented in [`<contextTransformUsage>` type attribute values](tr35-general.md#contextTransformUsage_type_attribute_values).

* <a id="core-annex-a-deprecated-structure-a12-renamed-attribute-values-for-element-item-3"></a> **In CLDR 25**: In CLDR 25, some of these values were renamed from their previous values for improved clarity:
...
### <a name="Deprecated_subelements_of_segmentations" id="core-unicode-locale-data-markup-language-ldml-annex-a-deprecated-structure-a13-deprecated-subelements-of" href="#Deprecated_subelements_of_segmentations">A.13 Deprecated subelements of `<segmentations>`</a>

* `<exceptions>` and `<exception>`: Replaced with `<suppressions>` and `<suppression>`.

### <a name="Element_cp" id="core-unicode-locale-data-markup-language-ldml-annex-a-deprecated-structure-a14-element-cp" href="#Element_cp">A.14 Element cp</a>
...
### <a name="validSubLocales" id="core-unicode-locale-data-markup-language-ldml-annex-a-deprecated-structure-a15-attribute-validsublocales" href="#validSubLocales">A.15 Attribute validSubLocales</a>
...
### <a name="postCodeElements" id="core-unicode-locale-data-markup-language-ldml-annex-a-deprecated-structure-a16-elements-postalcodedata-postcoderegex" href="#postCodeElements">A.16 Elements postalCodeData, postCodeRegex</a>

Instead please see other services that are kept up to date, such as <https://github.com/google/libaddressinput>

### <a name="telephoneCodeData" id="core-unicode-locale-data-markup-language-ldml-annex-a-deprecated-structure-a17-element-telephonecodedata" href="#telephoneCodeData">A.17 Element telephoneCodeData</a>

The element `<telephoneCodeData>` and its subelements have been deprecated and the data removed.

### <a name="languageData-language-territory" id="core-unicode-locale-data-markup-language-ldml-annex-a-deprecated-structure-a18-deprecated-attribute-of-supplemental-languagedatalanguage" href="#languageData-language-territory">A.18 Deprecated attribute of supplemental languageData/language</a>

* <a id="core-annex-a-deprecated-structure-a18-deprecated-attribute-of-supplemental-languagedatalanguage-item-1"></a> **For the supplemental**: For the supplemental `<languageData>` subelement `<language>`, the `territory` attribute has been deprecated and associated data removed.

* <a id="core-annex-a-deprecated-structure-a18-deprecated-attribute-of-supplemental-languagedatalanguage-item-2"></a> **A better source**: A better source for such information is the more detailed data in [Supplemental Territory Information](tr35-info.md#Supplemental_Territory_Information).


* * *

## <a name="Links_to_Other_Parts" id="core-unicode-locale-data-markup-language-ldml-annex-b-links-to-other-parts" href="#Links_to_Other_Parts">Annex B Links to Other Parts</a>
...
## <a name="LocaleId_Canonicalization" id="core-unicode-locale-data-markup-language-ldml-annex-c-localeid-canonicalization" href="#LocaleId_Canonicalization">Annex C. LocaleId Canonicalization</a>
...
### <a name="LocaleId_Definitions" id="core-unicode-locale-data-markup-language-ldml-annex-c-localeid-canonicalization-localeid-definitions">LocaleId Definitions</a>

#### <a name="1.-multimap-interpretation" id="core-unicode-locale-data-markup-language-ldml-annex-c-localeid-canonicalization-localeid-definitions-1-multimap-interpretation" href="#1.-multimap-interpretation">1. Multimap interpretation</a>
...
#### <a name="2.-alias-elements" id="core-unicode-locale-data-markup-language-ldml-annex-c-localeid-canonicalization-localeid-definitions-2-alias-elements" href="#2.-alias-elements">2. Alias elements</a>
...
#### <a name="3.-matches" id="core-unicode-locale-data-markup-language-ldml-annex-c-localeid-canonicalization-localeid-definitions-matches" href="#3.-matches">Matches</a>
...
#### <a name="4.-replacement" id="core-unicode-locale-data-markup-language-ldml-annex-c-localeid-canonicalization-localeid-definitions-4-replacement" href="#4.-replacement">4. Replacement</a>
...
* <a id="core-annex-c-localeid-canonicalization-localeid-definitions-4-replacement-territory-exception-item-1"></a> **If the field**: If the field = territory, and the replacement.field has more than one value, then look up the most likely territory for the base language code (and script, if there is one).

* <a id="core-annex-c-localeid-canonicalization-localeid-definitions-4-replacement-territory-exception-item-2"></a> **If that likely**: If that likely territory is in the list of replacements, use it.

* <a id="core-annex-c-localeid-canonicalization-localeid-definitions-4-replacement-territory-exception-item-3"></a> **Otherwise, use the**: Otherwise, use the first territory in the list.


#### <a name="5.-canonicalizing-syntax" id="core-unicode-locale-data-markup-language-ldml-annex-c-localeid-canonicalization-localeid-definitions-5-canonicalizing-syntax" href="#5.-canonicalizing-syntax">5. Canonicalizing Syntax</a>
...
##### Notes <a id="core-unicode-locale-data-markup-language-ldml-annex-c-localeid-canonicalization-localeid-definitions-5-canonicalizing-syntax-notes"></a>

* <a id="core-annex-c-localeid-canonicalization-localeid-definitions-5-canonicalizing-syntax-note-1"></a> **Note**: Note that "true" values cannot be removed from tvalues.
* Separator
  * Replace '\_' by '-'

### <a name="preprocessing" id="core-unicode-locale-data-markup-language-ldml-annex-c-localeid-canonicalization-preprocessing" href="#preprocessing">Preprocessing</a>
...
#### Notes <a id="core-unicode-locale-data-markup-language-ldml-annex-c-localeid-canonicalization-preprocessing-notes"></a>

* <a id="core-annex-c-localeid-canonicalization-preprocessing-note-1"></a> **Note**: Note that the “und” value disappears.
...
### <a name="processing-languageids" id="core-unicode-locale-data-markup-language-ldml-annex-c-localeid-canonicalization-processing-languageids" href="#processing-languageids">Processing LanguageIds</a>
...
* <a id="core-annex-c-localeid-canonicalization-processing-languageids-item-1"></a> **4. **Note:** there**: 4. **Note:** there are currently no valid 4-letter primary language subtags.

* <a id="core-annex-c-localeid-canonicalization-processing-languageids-item-2"></a> **While it is**: While it is extremely unlikely that BCP 47 would ever register them, if so then _languageAlias_ mappings will be supplied for them, mapping to defined CLDR language subtags (from the `idStatus="reserved"` set).
...
### <a name="processing-localeids" id="core-unicode-locale-data-markup-language-ldml-annex-c-localeid-canonicalization-processing-localeids" href="#processing-localeids">Processing LocaleIds</a>
...
* <a id="core-annex-c-localeid-canonicalization-processing-localeids-item-1"></a> **2**: 2.

* <a id="core-annex-c-localeid-canonicalization-processing-localeids-item-2"></a> **Use the bcp47**: Use the bcp47 data to replace keys, types, tfields, and tvalues by their canonical forms.

* <a id="core-annex-c-localeid-canonicalization-processing-localeids-item-3"></a> **See **U Extension**: See **U Extension Data Files** and **T Extension Data Files**.

* <a id="core-annex-c-localeid-canonicalization-processing-localeids-item-4"></a> **The matches are**: The matches are in the `alias` attribute value, while the canonical replacement is in the `name` attribute value.

* <a id="core-annex-c-localeid-canonicalization-processing-localeids-item-5"></a> **For example**: For example:
...
* <a id="core-annex-c-localeid-canonicalization-processing-localeids-item-6"></a> **3**: 3.

* <a id="core-annex-c-localeid-canonicalization-processing-localeids-item-7"></a> **Replace any unicode_subdivision_id**: Replace any unicode_subdivision_id that is a subdivision alias by its replacement value in the same way, using subdivisionAlias data.

* <a id="core-annex-c-localeid-canonicalization-processing-localeids-item-8"></a> **This applies, for**: This applies, for example, to the values for the 'sd' and 'rg' keys.

* <a id="core-annex-c-localeid-canonicalization-processing-localeids-item-9"></a> **However, where the**: However, where the replacement value is a two-letter region code, also append zzzz so that the result is syntactically correct.

* <a id="core-annex-c-localeid-canonicalization-processing-localeids-item-10"></a> **For example**: For example:
...
### <a name="optimizations" id="core-unicode-locale-data-markup-language-ldml-annex-c-localeid-canonicalization-optimizations" href="#optimizations">Optimizations</a>

* <a id="core-annex-c-localeid-canonicalization-optimizations-item-1"></a> **The above algorithm**: The above algorithm is a logical statement of the process, but would obviously not be directly suited to production code.

* <a id="core-annex-c-localeid-canonicalization-optimizations-item-2"></a> **Production-level code can**: Production-level code can use many optimizations for efficiency while achieving the same result.

* <a id="core-annex-c-localeid-canonicalization-optimizations-item-3"></a> **For example, the**: For example, the Alias Rules can be further preprocessed to avoid indefinite looping, instead doing a rule lookup once per subtag.

* <a id="core-annex-c-localeid-canonicalization-optimizations-item-4"></a> **As another example**: As another example, the small number of **Territory Exceptions** can be preprocessed to avoid the likely subtags processing.


* * *

## <a name="References" id="core-unicode-locale-data-markup-language-ldml-references" href="#References">References</a>
...
| [<a name="Calendars" href="#Calendars">Calendars</a>]    | Calendrical Calculations: The Millennium Edition by Edward M. Reingold, Nachum Dershowitz; Cambridge University Press; Book and CD-ROM edition (July 1, 2001); ISBN: 0521777526.

### Notes <a id="core-unicode-locale-data-markup-language-ldml-references-notes"></a>

* <a id="core-references-note-1"></a> **Note**: Note that the algorithms given in this book are copyrighted. |
