...
title: Modifications
---
## <a name="Unicode_Technical_Standard_35" id="Unicode_Technical_Standard_35" href="#Unicode_Technical_Standard_35">Unicode Technical Standard #35</a> <a id="modifications-unicode-technical-standard-35"></a>
...
### <a name="_Summary_" id="_Summary_" href="#_Summary_">_Summary_</a> <a id="modifications-unicode-technical-standard-35-summary"></a>
...
### <a name="MessageFormat" id="MessageFormat" href="#MessageFormat">MessageFormat</a> <a id="modifications-modifications-messageformat"></a>
...
### <a name="Locale_Identifiers_and_Names" id="Locale_Identifiers_and_Names" href="#Locale_Identifiers_and_Names">Locale Identifiers and Names</a> <a id="modifications-modifications-locale-identifiers-and-names"></a>
...
### <a name="Misc" id="Misc" href="#Misc">Misc.</a> <a id="modifications-modifications-misc"></a>
...
### <a name="DateTime_formats" id="DateTime_formats" href="#DateTime_formats">DateTime formats</a> <a id="modifications-modifications-datetime-formats"></a>
...
### <a name="Numbers" id="Numbers" href="#Numbers">Numbers</a> <a id="modifications-modifications-numbers"></a>
...
### <a name="Units_of_Measurement" id="Units_of_Measurement" href="#Units_of_Measurement">Units of Measurement</a> <a id="modifications-modifications-units-of-measurement"></a>
...
### <a name="Collation" id="Collation" href="#Collation">Collation</a> <a id="modifications-modifications-collation"></a>
...
### <a name="Keyboards" id="Keyboards" href="#Keyboards">Keyboards</a> <a id="modifications-modifications-keyboards"></a>
...
### <a name="Modifications_section" id="Modifications_section" href="#Modifications_section">Modifications section</a> <a id="modifications-modifications-modifications-section"></a>

* The Modifications section was split out to its own file, [Appendix A, Modifications](tr35-modifications.md)

### <a name="Acknowledgments_section" id="Acknowledgments_section" href="#Acknowledgments_section">Acknowledgments section</a> <a id="modifications-modifications-acknowledgments-section"></a>
...
* <a id="modifications-modifications-acknowledgments-section-rule-1"></a> **You may not**: You may not make copies of or modifications to this publication for public distribution, or incorporate it in whole or in part into any product or publication without the express written permission of Unicode.
...
* <a id="modifications-modifications-acknowledgments-section-rule-2"></a> **but make no**: but make no express or implied representation or warranty of any kind and assume no responsibility or liability for errors or omissions or for consequential or incidental damages that may arise therefrom.
